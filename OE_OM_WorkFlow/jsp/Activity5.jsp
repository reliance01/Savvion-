<%--  This JSP has been generated by using from xsl version 9.0 at Wed Mar 09 17:54:35 IST 2022 --%>
<!DOCTYPE html>
...
<input name="_PageName" type="hidden" value="TCM">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.TCM.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.TCM.ApproveDecision.label"></sbm:message></Label>
          </td>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
        ...
        <tr>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="checkbox1"><sbm:message key="dataslot.TCM.IsOEOnline.label"></sbm:message></Label>
          </td>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
...
var allWidgets = [{widget:'textField1', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ApproveDecision', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'ApproveDecision', dataSlotType:'STRING'}, dsType:'', service:'false'},
{widget:'checkbox1', bound:'true', editable:'true', type:'sbm.checkbox', source: {type:'DATASLOT', dataSlotName:'IsOEOnline', dataSlotType:'BOOLEAN'}, target:{type:'DATASLOT', dataSlotName:'IsOEOnline', dataSlotType:'BOOLEAN'}, dsType:'', service:'false'}
];
var businessObjects = [];
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("Activity5.jsp")%>';
