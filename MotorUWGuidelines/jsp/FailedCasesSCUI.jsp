...
<%! String _PageName = "FailedCasesSCUI"; %>
...
<input name="_PageName" type="hidden" value="FailedCasesSCUI">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.FailedCasesSCUI.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MotorUWGuidelines',processType:'bizlogic',maxMultiLineLength:${maxMultiLineLength},adapletCache:{}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("FailedCasesSCUI.jsp")%>';
