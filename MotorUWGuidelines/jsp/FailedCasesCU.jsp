...
<%! String _PageName = "FailedCasesCU"; %>
...
<input name="_PageName" type="hidden" value="FailedCasesCU">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.FailedCasesCU.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("FailedCasesCU.jsp")%>';
