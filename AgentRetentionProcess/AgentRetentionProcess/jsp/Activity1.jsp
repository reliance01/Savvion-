...
<div>
    ...
    <table class="agentDtl" id='updationTbl'>
        <tr>
           ...
           <td class="fieldValue">
             <textarea id='claimDDRmk' rows='2' cols='24' disabled='disabled'></textarea>
           </td>
        </tr>
        <tr>
           ...
           <td class="fieldValue">
             <textarea id='uwDDRmk' rows='2' cols='24' disabled='disabled'></textarea>
           </td>
        </tr>      
        <tr>
           ...
           <td class="fieldValue">
             <textarea id='opsDDRmk' rows='2' cols='24' disabled='disabled'></textarea>
           </td>
        </tr>
        <tr>
           ...
           <td class="fieldValue">
             <textarea id='itDDRmk' rows='2' cols='24' disabled='disabled'></textarea>
           </td>
        </tr>
        <tr>
           ...
           <td class="fieldValue">
             <textarea id='accountDDRmk' rows='2' cols='24' disabled='disabled'></textarea>
           </td>
        </tr>
        <tr>
           ...
           <td class="fieldValue">
             <textarea id='strategyDDRmk' rows='2' cols='24' disabled='disabled'></textarea>
           </td>
        </tr>
      </table><br />
      <table class='agentDtl'>
        <tr>
           <td class="fieldName" style='width:5%;'>Immediate Manager</td>
           <td class="fieldValue">
               <input type='text' id='immedtMgr' size='25' />
           </td>
        </tr>
        <tr>
...

{
   ...
   $('#strategyDD').multiselect({beforeclose : function(event,ui){enableNextOption('strategyDD','strategySpocDD','Select Strategy','Select Strategy Spocs'),setSpocList('strategyDD','strategySpocDD','getStrategySpocs')}});
   ...
   //Remark Validations
    ...
    $('#claimSpocDD').change(function(){enableRemark(this.id, 'claimDDRmk')});
    $('#uwSpocDD').change(function(){enableRemark(this.id, 'uwDDRmk')});
    $('#opsSpocDD').change(function(){enableRemark(this.id, 'opsDDRmk')});
    $('#itSpocDD').change(function(){enableRemark(this.id, 'itDDRmk')});
    $('#accountSpocDD').change(function(){enableRemark(this.id, 'accountDDRmk')});
    $('#strategySpocDD').change(function(){enableRemark(this.id, 'strategyDDRmk')});
    ...
    $('textarea').focusout(function(){checkRemark(this.id)});
...
function enableNextOption(CurrentId,childId,Msg,childMsg)
...
function callbackGrid(val)
{
     if(val = 'Submit')
     {
        alert("task completed!!!!!"); //  $('#button01').click();
