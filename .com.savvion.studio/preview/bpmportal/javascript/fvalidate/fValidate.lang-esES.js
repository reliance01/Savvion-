...
fvalidate.i18n =
{
    ...
    {
        blank:      [
            ["Please enter value for '", 0,"' field."]
            ],
        length:     [
        ...
        number:     [
            ["The number you entered for '", 0,"' field is not valid. Specify the value between ", 1 , " and ", 2],
            ["The number you entered for '", 0,"' field is not valid."]
            ],
        numeric:    [
        ...
        decimalr:   [
        [0, " is not valid. Please re-enter a value compliant with following rules:\n-The number of digits in left side of decimal separator must be between ",1," and ",2,".\n-The number of digits in right side or decimal separator must be between ",3," and ",4,"."]
            ],
        ip:         [
            ["Please enter a valid IP for '",0,"' field."],
            ["The port number you specified, ", 0, ",  is out of range.\nIt must be between ", 1, " and ", 2]
            ],
        ssn:        [
            ["You need to enter a valid Social Security Number for '",0,"' field.\nYour SSN must be entered in 'XXX-XX-XXXX' format."]
            ],
        money:      [
        ...
        zip:        [
            ["Please enter a valid 5 or 9 digit Zip code for '",0,"' field."]
            ],
        phone:      [
            ...
            ["Please enter a valid phone number - seven or ten digits for '",0,"' field."]
            ],
        email:      [
            ["Please enter a valid email address for '",0,"' field."]
            ],
        url:        [
        ...
        checkbox:   [
            ["Please check ", 2, " before continuing"],
        ...
        document:   [
            ["Please attach a document for '",0,"' field."]
            ],
        xml:    [
            ["Please attach a xml file for '",0,"' field."]
            ],
        datetime:   [
