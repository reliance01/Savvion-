...
Ext.define('Ext.ux.form.DateTime', {
    ...
    ,onRender:function(ct, position) {
        ...
        if('below' === this.timePosition || 'bellow' === this.timePosition) {
            t = Ext.DomHelper.append(this.bodyEl, {tag:'table',style:'border-collapse:collapse',children:[
        ...
        var datetimeDateObj = t.child('tbody tr td[class=ux-datetime-date]');
        this.df.render(datetimeDateObj);
        this.df.el.down('table').dom.style.width = '100%';
        
        var datetimeTimeObj = t.child('tbody tr td[class=ux-datetime-time]');
        this.tf.render(datetimeTimeObj);
        this.tf.el.down('table').dom.style.width = '100%';
    ...
    ,setSize:function(w, h) {
        ...
        if('below' === this.timePosition) {
			...
			this.tf.setSize((this.timeWidth - 4), h);
        }
    } 
    ...
    ,updateHidden:function() {
        if(this.isRendered) {
            var value = this.dateValue instanceof Date ? Ext.Date.format(this.dateValue, this.hiddenFormat) : '';
    ...
    ,getLayout: function(){
      return this.ownerCt ? (this.shadowOwnerCt || this.ownerCt).getLayout() : null;
    }
}); 
