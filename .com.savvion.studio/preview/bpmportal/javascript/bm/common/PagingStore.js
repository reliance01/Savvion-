 ...
 */
Ext.ns('Ext.ux.data');
Ext.ux.data.PagingStore = Ext.create('Ext.data.Store', {
...
Ext.define('Ext.ux.data.PagingDirectStore' , {
...
Ext.define('Ext.ux.data.PagingXmlStore' , {
	extend: 'Ext.ux.data.PagingStore',
    constructor: Ext.data.XmlStore.prototype.constructor
});


Ext.define('Ext.ux.data.PagingArrayStore', {
	extend: 'Ext.ux.data.PagingStore',
	alias : ['widget.pagingarraystore'],
...
Ext.define('Ext.ux.data.PagingSimpleStore', {
	extend: 'Ext.ux.data.PagingStore',
	alias : ['widget.pagingsimplestore'],
    constructor: Ext.data.ArrayStore.prototype.constructor,
    loadData: function (data, append) {
        if (this.expandData === true) {
            var r = [];
