...
function checkBLInstalledbutPublished(theForm,chkbox,appStatus){
	...
	checkAllBLInstalledbutPublished(document.form);
    }
   checkRefreshBtnStatus(document.form); 
   publishBizLogicButCheck(document.form);
}
...
function checkBSInstalledbutPublished(theForm,chkbox,pubstatus){
	...
	checkAllBSInstalledbutPublished(document.form);
    }
