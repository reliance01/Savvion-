...
Calendar.setup = function (params) {
	...
	var cal = window.calendar;
		if (dateEl)
			params.date = Date.parseDate1(dateEl.value || dateEl.innerHTML, dateFmt);
        if (!(cal && params.cache)) {
...
Date.monthNames = new Array('Janvier','F\u00e9vrier','Mars','Avril','Mai','Juin','Juillet','Ao\u00fbt','Septembre','Octobre','Novembre','D\u00e9cembre');
// Month abbreviations. Change this for local month names
//Date.monthAbbreviations = new Array('Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec');
Date.monthAbbreviations = new Array('Janv.','F\u00e9vr.','Mars','Avr.','Mai','Juin','Juil.','Ao\u00fbt','Sept.','Oct.','Nov.','D\u00e9c.');
// Full day names. Change this for local month names
//Date.dayNames = new Array('Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday');
Date.dayNames = new Array('Dimanche','Lundi','Mardi','Mercredi','Jeudi','Vendredi','Samedi');
// Day abbreviations. Change this for local month names
//Date.dayAbbreviations = new Array('Sun','Mon','Tue','Wed','Thu','Fri','Sat');
Date.dayAbbreviations = new Array('Dim','Lun','Mar','Mer','Jeu','Ven','Sam');
