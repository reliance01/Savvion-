...
function validateCalendar(checkCalName) {
    if (checkCalName == true) {
        if(!checkForWhitespace("document.forms[0]", getLocalizedString("Calendar_Name"), "calName")) {
        return false;
        }
        
        if(checkSpecialChars(document.forms[0].calName.value) || (document.forms[0].calName.value.indexOf("#") != -1)) {
        alert(calenderi18["bizCalAlert10"]);
    
        return false;
        }
    }
    
    if(checkSpecialCharsForCalendar(document.forms[0].calDesc.value)) {
        alert(calenderi18["bizCalAlert56"]);
        return false;
    }
     if(checkDescChars(document.forms[0].calDesc.value) != -1) {
        alert(calenderi18["bizCalAlert12"]);
        return false;
    }
    ...
    if(startTime >= endTime) {
        alert(calenderi18["bizCalAlert14"]);
        //document.forms[0].bizHoursStartTimeHrs.focus();
        return (false);
    }
    ...
    if(reg_startTime < reg_endTime) {
        ...
        {
                alert(calenderi18["bizCalAlert15"]);
        //document.forms[0].lunchStartTimeHrs.focus();
        return (false);
        }
        ...
        {
                alert(calenderi18["bizCalAlert16"]);
        //document.forms[0].lunchEndTimeHrs.focus();
        return (false);
        }
        if(mdb_startTime >= mdb_endTime) {
                alert(calenderi18["bizCalAlert17"]);
        //document.forms[0].lunchStartTimeHrs.focus();
        return (false);
        }
        ...
        {
                alert(calenderi18["bizCalAlert18"]);
        //document.forms[0].lunchStartTimeHrs.focus();
        return (false);
        }
        ...
        {
                alert(calenderi18["bizCalAlert19"]);
        //document.forms[0].lunchEndTimeHrs.focus();
        return (false);
        }
        
        if(mdb_startTime >= mdb_endTime) {
                alert(calenderi18["bizCalAlert20"]);
        //document.forms[0].lunchStartTimeHrs.focus();
        return (false);
        }
    }
    ...
    {
        alert(calenderi18["bizCalAlert21"]);
        return false;
    }
    ...
    {
        alert(calenderi18["bizCalAlert22"]);
...
function deleteCalendars(count) {
    ...
    if ( document.forms[0].calName.value == "") {
        alert(calenderi18["bizCalAlert23"]);

        return false;
    }
    // confirm for delete
    if (confirm(calenderi18["bizCalAlert24"])) {
...
function fillMonthDropDown(eleName)
{
    ...
    drop_down.options[0] = new Option(getLocalizedString("Jan") , "January");
    drop_down.options[1] = new Option(getLocalizedString("Feb") , "February");
    drop_down.options[2] = new Option(getLocalizedString("Mar") , "March");
    drop_down.options[3] = new Option(getLocalizedString("Apr") , "April");
    drop_down.options[4] = new Option(getLocalizedString("May") , "May");
    drop_down.options[5] = new Option(getLocalizedString("Jun") , "June");
    drop_down.options[6] = new Option(getLocalizedString("Jul") , "July");
    drop_down.options[7] = new Option(getLocalizedString("Aug") , "August");
    drop_down.options[8] = new Option(getLocalizedString("Sep") , "September");
    drop_down.options[9] = new Option(getLocalizedString("Oct") , "October");
    drop_down.options[10] = new Option(getLocalizedString("Nov") , "November");
    drop_down.options[11] = new Option(getLocalizedString("Dec") , "December");
}
...
function fillMonthDropDownWithAll(eleName)
{
    ...
    drop_down.options[0] = new Option(getLocalizedString("SelectOne") , "-1");
    drop_down.options[1] = new Option(getLocalizedString("JanuaryFN"), "January");
    drop_down.options[2] = new Option(getLocalizedString("FebruaryFN") , "February");
    drop_down.options[3] = new Option(getLocalizedString("MarchFN") , "March");
    drop_down.options[4] = new Option(getLocalizedString("AprilFN") , "April");
    drop_down.options[5] = new Option(getLocalizedString("MayFN") , "May");
    drop_down.options[6] = new Option(getLocalizedString("JuneFN") , "June");
    drop_down.options[7] = new Option(getLocalizedString("JulyFN") , "July");
    drop_down.options[8] = new Option(getLocalizedString("AugustFN") , "August");
    drop_down.options[9] = new Option(getLocalizedString("SeptemberFN") , "September");
    drop_down.options[10] = new Option(getLocalizedString("OctoberFN"), "October");
    drop_down.options[11] = new Option(getLocalizedString("NovemberFN") , "November");
    drop_down.options[12] = new Option(getLocalizedString("DecemberFN") , "December");
}
...
function fillYearDropDownWithAll(eleName,startYear,endYear)
{
    ...
    var counter = stYear;
    drop_down.options[0] = new Option(getLocalizedString("SelectOne"), "-1");
    drop_down.options[1] = new Option(getLocalizedString("All") , "All");
    for(var i=0;i<diff;i++) {
...
function getDate() {
    ...
    if(selDate != null){
        ...
        for(idx=0; idx<dateArr.length; idx++){
            dateArr[idx] = getLocalizedString(dateArr[idx]);
        }    
        selDate = dateArr.join(" ");    
    }
...
function addHoliday() {
    ...
    if(!checkForWhitespace("document.forms[0]", getLocalizedString("Holiday_Name"), "holName")) {
        return false;
    }
...
function checkForWhitespace(the_form_path, display_field_name, actual_field_name)
{
    ...
    if (field_tobe_accessed.value == "") {
        getAjaxLocalizedString('bizCalAlert63',[display_field_name]);
        ...
        if (no_of_space_chars == length_of_value){
            getAjaxLocalizedString('bizCalAlert64',[display_field_name]);
...
function checkForNumeric(the_form_path, display_field_name, actual_field_name){
    ...
    if (isNaN(field_tobe_accessed.value)) {
        getAjaxLocalizedString('bizCalAlert65',[display_field_name]);
        field_tobe_accessed.select();
        field_tobe_accessed.focus();
        return false;
    }
                               ...
                               actual_field_name, max_length, min_length)
{
    ...
    if ( (field_length > max_length) || (field_length < min_length) ) {
        if ( min_length == max_length ) {
            getAjaxLocalizedString('bizCalAlert66',[max_length, display_field_name]);
        } else  {
			getAjaxLocalizedString('bizCalAlert67',[min_length, max_length, display_field_name]);
        }
        field_tobe_accessed.select();
        field_tobe_accessed.focus();
        return (false);
...
function checkForDate(the_form_path, year_field_name, month_field_name, date_field_name) {
    ...
    if ( (eval(year_val) < 1900 )||(eval(year_val) > 9999 )) {
		getAjaxLocalizedString('bizCalAlert68',["1900","9999"]);
        year_field.select();
        year_field.focus();
        return (false);
    }
    ...
    if ( (eval(date_val) < 1) || (eval(date_val) > number_of_days ) ) {
		getAjaxLocalizedString('bizCalAlert69',[number_of_days]);        
        date_field.select();
        date_field.focus();
        return (false);
    }
