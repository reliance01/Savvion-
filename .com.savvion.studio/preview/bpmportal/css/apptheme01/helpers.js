...
//
//
//  For each type for which you wish to add a custom helper element,
//  add a function below named fieldHelper_mytype, where mytype
//  corresponds to the name you've decided upon for the element type.
//

function fieldHelper_date( name )
{
   //document.write( "&nbsp;<a href=\"javascript:show_calendar( 'forms[0]." + name + "' );\" onmouseover=\"window.status='Select Date';return true;\" onmouseout=\"window.status='';return true;\">" );
   //document.write( '<img src="' + bizsiteroot + '/images/calendar.gif" width=24 height=22 border=0></a>' );
