                        ...
                        <td class="FilterTblEmboss" width="98%" align="left">
                          <table border="0" cellpadding="2" cellspacing="1">
                            <tr>
                              ...
                              <td align="right" nowrap class="DataLabelLft"><sbm:message key="SearchGrp" />&nbsp;-</td>
...
<% } else { %>
        <b><a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=*" class="ActionLnk"><sbm:message key="All" /></a></b> &nbsp;|&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("A*")) { %>
        <b>A</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=A*" class="ActionLnk">A</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("B*")) { %>
        <b>B</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=B*" class="ActionLnk">B</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("C*")) { %>
        <b>C</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=C*" class="ActionLnk">C</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("D*")) { %>
        <b>D</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=D*" class="ActionLnk">D</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("E*")) { %>
        <b>E</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=E*" class="ActionLnk">E</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("F*")) { %>
        <b>F</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=F*" class="ActionLnk">F</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("G*")) { %>
        <b>G</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=G*" class="ActionLnk">G</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("H*")) { %>
        <b>H</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=H*" class="ActionLnk">H</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("I*")) { %>
        <b>I</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=I*" class="ActionLnk">I</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("J*")) { %>
        <b>J</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=J*" class="ActionLnk">J</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("K*")) { %>
        <b>K</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=K*" class="ActionLnk">K</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("L*")) { %>
        <b>L</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=L*" class="ActionLnk">L</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("M*")) { %>
        <b>M</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=M*" class="ActionLnk">M</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("N*")) { %>
        <b>N</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=N*" class="ActionLnk">N</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("O*")) { %>
        <b>O</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=O*" class="ActionLnk">O</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("P*")) { %>
        <b>P</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=P*" class="ActionLnk">P</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("Q*")) { %>
        <b>Q</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=Q*" class="ActionLnk">Q</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("R*")) { %>
        <b>R</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=R*" class="ActionLnk">R</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("S*")) { %>
        <b>S</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=S*" class="ActionLnk">S</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("T*")) { %>
        <b>T</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=T*" class="ActionLnk">T</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("U*")) { %>
        <b>U</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=U*" class="ActionLnk">U</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("V*")) { %>
        <b>V</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=V*" class="ActionLnk">V</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("W*")) { %>
        <b>W</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=W*" class="ActionLnk">W</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("X*")) { %>
        <b>X</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=X*" class="ActionLnk">X</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("Y*")) { %>
        <b>Y</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=Y*" class="ActionLnk">Y</a>&nbsp;
<% } %>
<% if (umBean.isSameAlphabetQueryForGroup("Z*")) { %>
        <b>Z</b> &nbsp;
<% } else { %>
        <a href="../administration/UserManagementServlet?action=searchGroup&queryGroupByAlphabet=Z*" class="ActionLnk">Z</a>&nbsp;
<% } %>
        </td>
      </tr>
    </table>
...
<% if (umBean.isSortedByResultGroupName()) { %>
              <td class="ColHdrSort">
                <table border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><a href="../administration/UserManagementServlet?action=searchGroup&sortedBy=ResultGroupName" class="ColHdrLnk"><sbm:message key="GrpName" /></a></td>
    <% if (umBean.isResultGroupAscending()) { %>
                    <td><a href="../administration/UserManagementServlet?action=searchGroup&sortedBy=ResultGroupName" title="ascending Order"><img src="../css/<c:out value="${bizManage.theme}" />/images/sort_up.gif" width="16" height="16" border="0" /></a></td>
    <% } else { %>
                    <td><a href="../administration/UserManagementServlet?action=searchGroup&sortedBy=ResultGroupName" title="Descending Order"><img src="../css/<c:out value="${bizManage.theme}" />/images/sort_down.gif" width="16" height="16" border="0" /></a></td>
    <% } %>
                  </tr>
                </table>
              </td>
<% } else { %>
              <td class="ColHdr"><a href="../administration/UserManagementServlet?action=searchGroup&sortedBy=ResultGroupName" class="ColHdrLnk"><sbm:message key="GrpName" /></a></td>
<% } %>
            </tr>
...
<% for (int i = mpBean4.getStartIndex(); i < mpBean4.getEndIndex(); i++) { %>
          <tr>
            <td class="<%= (i%2 == 1) ? "ChkBoxAlt" : "ChkBox" %>">
              <input type="radio" class="InptChkBox" name="groupName" value="<%=umBean.getSearchResultGroupList()[i].getId()%>" />
            </td>
...
<% } else { %>
      <a href="../administration/UserManagementServlet?action=searchGroup&currentPageWindow=<%= mpBean4.getCurrentWindow() - 1 %>" class="ActionLnk">&lt;<sbm:message key="PREVIOUS_PAGE" />&nbsp;<a>
<% } %>
...
<% for (int i = mpBean4.getStartPage(); i <= mpBean4.getEndPage(); i++) {
    if ( i > 0 && i <= mpBean4.getTotalPage()) {
        if (mpBean4.getCurrentPage() == i) { %>
          <%= i %>
        <% } else { %>
          <a href="../administration/UserManagementServlet?action=searchGroup&currentPage=<%= i %>" class="ActionLnk"><%= i %></a>
        <% } %>
    <% } %>
<% } %>
...
<% } else { %>
      <a href="../administration/UserManagementServlet?action=searchGroup&currentPageWindow=<%= mpBean4.getCurrentWindow() + 1 %>" class="ActionLnk"><sbm:message key="NEXT_PAGE" />&gt;<a>
<% } %>
<!--
        &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;
