...
<title><sbm:message key="AddNonWorkingTime" /> -  <sbm:message key="SBM" /></title>
...
<script type="text/javascript" src="../javascript/nonworkinghrs.js"></script>
...
function applyRestriction(){
    for (var i=0; i<document.forms[0].elements.length; i++) {
        if (document.forms[0].elements[i].name == 'radiobuttontype' && document.forms[0].elements[i].checked == true) {
            if(document.forms[0].elements[i].value == 'Holiday' && document.forms[0].bizNonWrkHourYear.value != 'All') {
                    ...
                    document.forms[0].radiobutton[1].checked = false;
...
<input type="hidden" name="typeselected" value="Weekend" />
<input type="hidden" name="optionselected" value="date" />
<div align="center">
    ...
    <tr>
      <td>
        <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
          <tr>
            <td class="PopTitle">&nbsp;&nbsp;<sbm:message key="AddNonWorkingTime" /></td>
          </tr>
          <tr>
                        ...
                        <td class="SegTblInBg">
                          <table border="0" cellpadding="6" cellspacing="1" width="100%" class="SegDataTbl">
                            <tr>
                              ...
                              <td width="100%" class="SegFieldLft"> <input type="text" class="InptTxt" name="nonwrkname" size="40" maxlength="32" />
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td class="SegFieldLftAlt"><table border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    ...
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    <td> <b>
                                      <input name="radiobuttontype" type="radio" class="InptChkBox" value="Weekend" checked="checked" onclick="onSelectType('Weekend');" />
                                      </b> </td>
                            ...
                            <tr>
                              ...
                              <td class="SegFieldLftAlt"><select class="InptSelect" name="bizNonWrkHourMonth" onchange=
                              "fillDate();">
                                </select></td>
                            </tr>
                            <tr>
                              <td nowrap="nowarp" class="SegValRt"><sbm:message key="SelectOne" />:</td>
                            ...
                            <tbody>
                              <tr>
                                <td class=SegFieldCntr colspan="2"> <table border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td class="BtnSpace"> <input type="button" name="save" value=" <sbm:message key="save" /> "  class="PopButton" onmouseover="this.className='PopButtonHover';" onmouseout="this.className='PopButton';" onclick="javascript:if(saveNonWorkingHrs('add')) { window.close() }" />
                                      </td>
                                      <td class="BtnSpace"> <input type="button" name="saveaddnew" value="<sbm:message key="SaveAndAddNew" />" class="ScrnButton" onmouseover="this.className='ScrnButtonHover';"
                                       onmouseout="this.className='ScrnButton';" style="width=140px" onclick="javascript:if(saveNonWorkingHrs('add')) {MM_goToURL('parent','#');window.location.reload(true);}" />
                                      </td>
                                      <td class="BtnSpace"> <input type="button" name="resetBtn" value="<sbm:message key="reset" />" class="ScrnButton" onmouseover="this.className='ScrnButtonHover';" onmouseout="this.className='ScrnButton';" onclick="onSelectType('Weekend');window.location.reload(true);" />
                                      </td>
