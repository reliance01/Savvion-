...
<title><sbm:message key="WorkingTimeDetails" /> -  <sbm:message key="SBM" /></title>
...
<script type="text/javascript" src="../javascript/workinghrs.js"></script>
...
<form name="workinghrsdet" >
<%@ include file="../common/include_form_body.jsp" %>
<input type="hidden" name="optionselected" value="<%=opt%>" />
<div align="center">
    ...
    <tr>
      <td>
        <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
          <tr>
            <td class="PopTitle">&nbsp; <sbm:message key="WorkingTimeDetails" /></td>
          </tr>
          <tr>
                            ...
                            <tr>
                              ...
                              <td class="SegFieldLft"> <table cellspacing="0" cellpadding="0" border="0">
                                  <tbody>
                                    <tr>
                                      <td><b>
                                        <input class="InptChkBox" type="radio" <%=("day".equals(opt))? "selected=\"selected\"" :""%> value="day" name="splBizHourFormat" onclick="onSelectOption('day');" />
                                        </b></td>
                            ...
                            <tbody>
                              <tr>
                                <td colspan="2" class="SegFieldCntr"> <table border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td class="BtnSpace"> <input type="button" name="save" value=" <sbm:message key="save" /> "  class="PopButton" onmouseover="this.className='PopButtonHover';" onmouseout="this.className='PopButton';" onclick="javascript:if(saveWorkingHrs(<%=val%>)) {window.close()}" />
                                      </td>
                                      ...
                                      <td class="BtnSpace"> <input type="button" name="delete" value="<sbm:message key="Delete" />"  class="PopButton" onmouseover="this.className='PopButtonHover';" onmouseout="this.className='PopButton';" onclick="javascript:opener.deleteWorkingTimeFromId(<%=val%>);window.close()" />
                                      </td>
