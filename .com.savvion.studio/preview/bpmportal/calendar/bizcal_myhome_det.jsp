...
<%@ page errorPage="bizcal_myhome_error.jsp" %>
...
<%
    ...
    if (actn != null && actn.equals("restoreDefault")) {
        CalendarAction.self().execute(request, response);
        Object calObj = request.getAttribute("calName");
    if (calObj != null) {
        calName = calObj.toString();
    } else {
        calName = null;
    }
    }
    ...
    if(actn != null && (actn.trim().equals("createCal") ||
       actn.trim().equals("editCal"))) {
        ...
        if (calName == null) {
            ...
            calvo = CalDataController.self().getCalendarMetaData(calName);
        }
    }
    boolean edit = false;
    if(calvo != null) {
...
function restoreDefaultCalendar() {
    if (confirm("Calendar will be restored to its default settings.Do you want to continue? ")) {
        document.forms[0].action.value='restoreDefault';
        document.forms[0].submit();
        return true;
    }
}
...
<form name="BizCalendarDetails" method="post" action="../calendar/bizcal_myhome_det.jsp">
...
<input type="hidden" name="usercalendar" value="true">
...
<div id="northDiv">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="breadcrumbSec">
        <tr>
         ...
         %>
          <td class="SmlTxt" height="20">&nbsp;&nbsp;<a href=javascript:encodeHrefUrl("../calendar/bizcal_myhome_view.jsp?calName=<%=URLEncoder.encode(calName,PortalConstants.UTF8)%>&year=<%=aYear%>") class="ActionLnk"><sbm:message key="Home" />:&nbsp;<sbm:message key="Preferences" />&nbsp;(<sbm:message key="calendar" />)</a>&nbsp;&gt;&nbsp;<b><sbm:message key="CalendarDetails" /></b></td>
        </tr>
    </table>
</div>
<div id="cmdDiv">
    ...
    <tr align="center">
        <td align="center" class="ButtonDarkBg">
            <table border="0" cellspacing="0" cellpadding="0">
             <tr>
                <td width="50%" height="20" class="BtnSpace"> <input type="button" name="Submit1323222" value="<sbm:message key="RestoreDefaultCalBtn" />" class="ScrnButton" onmouseover="this.className='ScrnButtonHover';" onmouseout="this.className='ScrnButton';" onclick="return restoreDefaultCalendar();" style="width:190" />
                </td>
                ...
                <td width="50%" class="BtnSpace"> <input type="button" name="cancel" value="<sbm:message key="cancel" />" class="ScrnButton" onmouseover="this.className='ScrnButtonHover';" onmouseout="this.className='ScrnButton';" onclick="MM_goToURL('parent','../calendar/bizcal_myhome_view.jsp?calName=<%=calName%>&year=<%=aYear%>');return document.MM_returnValue" />
                </td>
              </tr>
            </table>
        </td>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr>
      <td class="SegTitle">&nbsp;&nbsp;<sbm:message key="General" /></td>
    </tr>
    <tr>
      <td class="SegTblEmboss" align="center"> <table width="100%" class="SegInbetweenTbl">
          <tr>
            <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="SegTblInBg"> <table class="SegDataTbl" cellpadding="4" cellspacing="1" border="0" width="100%">
                      <tr>
                        <td width="50%" class="SegFieldRt"><sbm:message key="Name" />:</td>
                        <td width="50%" class="SegValLft"><sbm:message key="BPM_Portal_Calendar.CustomCalendar" /></td>
                      ...
                      <tr>
                        ...
                        <td class="SegValLftAlt"> <textarea name="calDesc" class="InptTxtArea" wrap="VIRTUAL" cols="40" rows="4"><%=calvo.getDescription()%></textarea>
                        </td>
                      </tr>
                      <tr>
      ...
      <td class="SegTblEmboss" align="center"><table width="100%" class="SegInbetweenTbl">
          <tr>
            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td height="36"><input type="button" name="AddWorkingTimeBtn"  onclick="MM_openBrWindow('../calendar/pop_wrkhrs_add.jsp','addworkinghours','width=670,height=230')" class="ScrnButton" onmouseover="this.className='ScrnButtonHover';" onmouseout="this.className='ScrnButton';" value='<sbm:message key="AddWorkingTime" />...' />
                    <input type="button" name="DelWorkingTimeBtn" onclick="deleteWorkingTime();" class="ScrnButton" onmouseover="this.className='ScrnButtonHover';" onmouseout="this.className='ScrnButton';" value='<sbm:message key="DelWorkingTime" />' />
                  </td>
                </tr>
              </table></td>
          </tr>
      ...
      <td class="SegTblEmboss" align="center"><table width="100%" class="SegInbetweenTbl">
          <tr>
            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td height="36">
                  <input name="addNonWrkHrs" type="button" onclick="MM_openBrWindow('../calendar/pop_nonwrkhrs_add.jsp','addnonwrkhrs','width=642,height=260')" class="ScrnButton" onmouseover="this.className='ScrnButtonHover';" onmouseout="this.className='ScrnButton';" value='<sbm:message key="AddNonWorkingTime" />' />
                    <input name="delNonWrkHrs" type="button"  value='<sbm:message key="DelNonWorkingTime" />' class="ScrnButton" onmouseover="this.className='ScrnButtonHover';" onmouseout="this.className='ScrnButton';" onclick='deleteNonWorkingTime();' />
                  </td>
                </tr>
              </table></td>
          </tr>
