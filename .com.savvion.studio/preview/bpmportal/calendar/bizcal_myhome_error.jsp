...
<body onload="positionDiv('TblCol','ListDivPadID');">
...
<table width="100%" border="0" cellspacing="6" cellpadding="0">
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="ListLineBg"><img alt="" src="../css/<c:out value="${bizManage.theme}" />/images/blank.gif" width="1" height="2" /></td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="ListTblBgPad" id="TblCol" height="416">&nbsp; </td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
...
<div  id="ListDivPadID" style="visibility: visible" class="ListDivPad">
  <table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    <tr>
      <td class="CmnTblEmboss" align="center" valign="top">
        <table border="0" width="100%" cellpadding="6">
          <tr>
            <td class="ValLft" width="92%"><span class="Error"><b><sbm:message key="ApplicationTitle" />: </b>Calendar Page Error <br>
