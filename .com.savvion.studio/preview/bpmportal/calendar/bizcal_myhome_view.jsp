...
<%
    //String aValue = request.getParameter("restoreDefault");
    String calname = (String)request.getParameter("calName");
    session.setAttribute("calname", calname);

    if ("null".equals(calname) || calname == null) {
        response.sendRedirect("bizcal_myhome_list.jsp");
    } else if(calname.indexOf("|") == -1) {
        response.sendRedirect("bizcal_list.jsp");
    }
...
function setDefaults() {
    ...
    //setHolDefaults("<%=month%>");
    //setYearDefaults("<%=selectedYear%>");
    return true;
}
...
function restoreDefaultCalendar() {
    if (confirm("Calendar will be restored to its default settings.Do you want to continue? ")) {
        setValue('restoreDefault', '1');
        setValue('month', getValue('month'));
        setValue('year', getValue('year'));
        var doc = document.forms[0];
        doc.action.value = 'restoreDefaultCalendar';
        doc.submit();
        return true; 
    }
}
...
function canLink() {
    window.location="bizcal_myhome_list.jsp?myHomeView=true&calName="+'<%=calname%>';
}
//-->
</script>
...
<form name="bulk" method="post" action="../calendar/bizcal_myhome_view.jsp">
...
<input type="hidden" name="restoreDefault" value="" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td class="SmlTxt" height="20" nowrap="nowrap">&nbsp;&nbsp;<b><sbm:message key="Home" />:&nbsp;<sbm:message key="Preferences" />&nbsp;(<sbm:message key="calendar" />)</b></td>
    <td width="100%" align="right" class="SmlTxt">&nbsp;</td>
    <td height="20" align="right" nowrap="nowrap" class="SmlTxt"><a href=javascript:encodeHrefUrl('../calendar/bizcal_myhome_det.jsp?calName=<%=URLEncoder.encode(calname,PortalConstants.UTF8)%>') class="PsvTitleLnk"><sbm:message key="CalendarDetails" /></a>&nbsp;</td>
    <td align="right"><img src="../css/<c:out value="${bizManage.theme}" />/images/icon_sep.gif" width="16" height="16"></td>
    <td height="20" align="right" nowrap="nowrap" class="SmlTxt">&nbsp;<a href="javascript:canLink();" class="PsvTitleLnk"><sbm:message key="CalendarList" /></a>&nbsp;&nbsp;</td>
  </tr>
</table>
  ...
  <tr>
    <td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="484" align="center" valign="top" class="CalSegTblBgPad" id="CalSegTblBgPadId">
            <table border="0" cellspacing="4" cellpadding="4">
              <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td> <div  style="height:339px; z-index:1; visibility: visible; overflow: auto" class="CalListDivPad">
      ...
      <table width="100%" cellpadding="0" align="center" cellspacing="0" border="0">
        <tr align="center">
          <td class="ButtonDarkBg"> <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="BtnSpace">
                  <input type="button" name="restore default" value="<sbm:message key="RestoreDefaultCalBtn" />" class="ScrnButton" onMouseOver="this.className='ScrnButtonHover';" onMouseOut="this.className='ScrnButton';" onClick="return restoreDefaultCalendar();" style="width:190">
                </td>
              </tr>
            </table></td>
        </tr>
