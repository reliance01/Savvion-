...
matchWildcard(_listener.topic,name))
   ...
   this.doAjax= function(args) {
	   ...
	   /********Fix for CR#RPM00026347*******/
	   var northDiv = Ext.get('northDiv');	
	   if(body == null) body = "";
		   if (northDiv && northDiv.first() != null) {			
					var tokenName = northDiv.first().getAttribute('name')
					var tokenValue = northDiv.first().getAttribute('value');
					body = body +  encodeURIComponent(tokenName) + "=" + encodeURIComponent(tokenValue) + "&";		   
		   } else {
...
// If the text is not JSON parseable, then a SyntaxError is thrown.
    ...
    function postInitialize() {
        ...
        _jmaki.webRoot = '../'; // Fix for PCT-1216
        // load the theme       
