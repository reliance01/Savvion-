...
jmaki.widgets.yahoo.button.Widget = function(wargs) {
    ...
    if (typeof wargs.args != 'undefined') {
        ...
        if (typeof wargs.args.duallist != 'undefined') {
            duallist = wargs.args.duallist;
        }
        if (typeof wargs.args.sourcelist != 'undefined') {
            sourcelist = wargs.args.sourcelist;
        }
        if (typeof wargs.args.targetlist != 'undefined') {
            targetlist = wargs.args.targetlist;
        }
    ...
    */
    ...
    YAHOO.util.Event.onContentReady(buttonId, this.init);
