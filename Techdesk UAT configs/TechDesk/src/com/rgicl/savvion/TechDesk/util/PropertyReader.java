package com.rgicl.savvion.TechDesk.util;
...
public class PropertyReader 
{
    ...
    { 
        try 
        {  	
      	   	resrcBundle = new PropertyResourceBundle(PropertyReader.class.getClassLoader().getResourceAsStream("techdesk.properties"));      	  
        }
        catch (Exception ex) 
        {        	
        }
