...
alert("Service is " + wargs.service);
    var _widget = this;
    var columns = [];
...
jmaki.serialize = function(obj) {
    ...
    for (var l in obj) {
        var prop;
        if (obj[l] instanceof Array) {
            var ac = "[";
            for (var i=0; i < obj[l].length; i++) {
                    ac += jmaki.serialize(obj[l][i]);
                if (i < obj[l].length - 1) ac += ",";
            }
            ac += "]";
            prop = ac;
            props.push("'" +l + "'"  + ": " + prop);
        } else if (typeof obj[l] == "object") {
            prop = jmaki.serialize(obj[l]);
            props.push("'" +l + "'"  + ": " + prop);
        } else if (typeof obj[l] == "function") {
            // do nothing for now
        } else if (typeof obj[l] == 'string'){
           props.push("'" +l + "'"  + ":'" + obj[l] + "'");
        } else if (typeof obj[l] == 'number'){
           props.push("'" +l + "'"  + ":" + obj[l]);
        } else {
            props.push("unknown");
        }
