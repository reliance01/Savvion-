...
// CALENDAR COLORS
topBackground    = "#CCCCFF";         // BG COLOR OF THE TOP FRAME
bottomBackground = "#CCCCFF";         // BG COLOR OF THE BOTTOM FRAME
...
function setDateField(dateField) {
    ...
    calDateField.value = long2DateIfNecessary(calDateField.value);
...
function buildTopCalFrame() {
    ...
    var calDoc =
        ...
        "<CENTER>" +
        getMonthSelect() +
        "<INPUT NAME='year' VALUE='" + calDate.getFullYear() + "'TYPE=TEXT SIZE=4 MAXLENGTH=4 onClick='blur()'>" +
        "</CENTER>" +
        "</TD>" +
        "</TR>" +
        "<TR>" +
...
function long2DateIfNecessary(longNumStr) {
...
function long2Date(date) {
        ...
        dobj = new Date();
        dlong = Number(date.value);
        dobj.setTime(dlong);
        date.value = (dobj.getMonth() + 1) + '/' + dobj.getDate() + '/' + dobj.getFullYear();
...
function writeLong2Date(date) {
        ...
        if (isNaN(date)) { 
                 ...
                 dobj = new Date();
                 dlong = Number(date);
                 document.writeln(long2DateIfNecessary(dlong));
        }
}
