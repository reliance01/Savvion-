...
function fValidate( f, errorMode, groupError )
{
	...
	function addLabelProperties()
	{
		...
		while ( label = labels[i++] )
		{
			...
			// added by keivan
			//alert("label.htmlFor :"+label.htmlFor+
			//"\nf.elements[label.htmlFor] :"+f.elements[label.htmlFor]+
			//"\nf.elements[bizsite_dataslot_label.htmlFor] :"+f.elements["bizsite_dataslot_"+label.htmlFor]);
