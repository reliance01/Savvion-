...
public class SendMessageLocator extends org.apache.axis.client.Service implements com.audit.sms.SendMessage {
    ...
    public com.audit.sms.ISendMessage getBasicHttpBinding_ISendMessage() throws javax.xml.rpc.ServiceException {
    ...
    public com.audit.sms.ISendMessage getBasicHttpBinding_ISendMessage(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.audit.sms.BasicHttpBinding_ISendMessageStub _stub = new com.audit.sms.BasicHttpBinding_ISendMessageStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.audit.sms.ISendMessage.class.isAssignableFrom(serviceEndpointInterface)) {
                com.audit.sms.BasicHttpBinding_ISendMessageStub _stub = new com.audit.sms.BasicHttpBinding_ISendMessageStub(new java.net.URL(BasicHttpBinding_ISendMessage_address), this);
                _stub.setPortName(getBasicHttpBinding_ISendMessageWSDDServiceName());
                return _stub;
            }
        }
