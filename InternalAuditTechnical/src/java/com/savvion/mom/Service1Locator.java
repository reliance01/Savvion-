...
public class Service1Locator extends org.apache.axis.client.Service implements com.savvion.mom.Service1 {
    ...
    private java.lang.String Service1Soap12_address = "http://10.65.15.160:8081/Service1.asmx";
    ...
    public com.savvion.mom.Service1Soap_PortType getService1Soap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.savvion.mom.Service1Soap_PortType getService1Soap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.savvion.mom.Service1Soap12Stub _stub = new com.savvion.mom.Service1Soap12Stub(portAddress, this);
    ...
    private java.lang.String Service1Soap_address = "http://10.65.15.160:8081/Service1.asmx";
    ...
    public com.savvion.mom.Service1Soap_PortType getService1Soap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.savvion.mom.Service1Soap_PortType getService1Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.savvion.mom.Service1Soap_BindingStub _stub = new com.savvion.mom.Service1Soap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.savvion.mom.Service1Soap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.savvion.mom.Service1Soap12Stub _stub = new com.savvion.mom.Service1Soap12Stub(new java.net.URL(Service1Soap12_address), this);
                _stub.setPortName(getService1Soap12WSDDServiceName());
                return _stub;
            }
            if (com.savvion.mom.Service1Soap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.savvion.mom.Service1Soap_BindingStub _stub = new com.savvion.mom.Service1Soap_BindingStub(new java.net.URL(Service1Soap_address), this);
                _stub.setPortName(getService1SoapWSDDServiceName());
                return _stub;
            }
        }
