package rgiclcms.cms.savvion;

public class RequestObjectTechnicalApprovalVS {
   ...
   public String NextVSRole;
   public String NextVSId;
   ...
   public String getNextVSRole() {
      return this.NextVSRole;
   }

   public void setNextVSRole(String NextVSRole) {
      this.NextVSRole = NextVSRole;
   }

   public String getNextVSId() {
      return this.NextVSId;
   }

   public void setNextVSId(String NextVSId) {
      this.NextVSId = NextVSId;
   }
}
