...
public class ABLLongChar implements Serializable {
   private static final long serialVersionUID = -1312632755L;
   ...
   public ABLLongChar(String var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLLongChar)) {
         return false;
      } else {
         ABLLongChar var2 = (ABLLongChar)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLLongChar ::");
