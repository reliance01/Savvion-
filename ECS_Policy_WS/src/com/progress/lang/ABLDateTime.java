...
public class ABLDateTime implements Serializable {
   private static final long serialVersionUID = -1739927562L;
   private boolean _modified = false;
   private boolean _deleted = false;
   private boolean _new = true;
   private GregorianCalendar value = null;
   private boolean valueModified = false;
   private Boolean unknown = new Boolean(false);
   private boolean unknownModified = false;

   public ABLDateTime() {
   }

   public ABLDateTime(GregorianCalendar var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLDateTime)) {
         return false;
      } else {
         ABLDateTime var2 = (ABLDateTime)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLDateTime ::");
