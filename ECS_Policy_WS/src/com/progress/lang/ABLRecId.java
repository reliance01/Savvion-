...
public class ABLRecId implements Serializable {
   private static final long serialVersionUID = -217410736L;
   ...
   public ABLRecId(Long var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLRecId)) {
         return false;
      } else {
         ABLRecId var2 = (ABLRecId)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLRecId ::");
