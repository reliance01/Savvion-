...
public class ABLDate implements Serializable {
   private static final long serialVersionUID = 823850377L;
   ...
   public ABLDate(GregorianCalendar var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLDate)) {
         return false;
      } else {
         ABLDate var2 = (ABLDate)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLDate ::");
