...
public class ABLMemptr implements Serializable {
   private static final long serialVersionUID = 1707392020L;
   ...
   public ABLMemptr(Byte[] var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLMemptr)) {
         return false;
      } else {
         ABLMemptr var2 = (ABLMemptr)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLMemptr ::");
