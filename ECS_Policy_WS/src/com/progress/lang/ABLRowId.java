...
public class ABLRowId implements Serializable {
   private static final long serialVersionUID = -217093606L;
   ...
   public ABLRowId(Long var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLRowId)) {
         return false;
      } else {
         ABLRowId var2 = (ABLRowId)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLRowId ::");
