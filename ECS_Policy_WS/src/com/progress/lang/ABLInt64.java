...
public class ABLInt64 implements Serializable {
   private static final long serialVersionUID = -225438606L;
   ...
   public ABLInt64(Long var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLInt64)) {
         return false;
      } else {
         ABLInt64 var2 = (ABLInt64)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLInt64 ::");
