...
public class ABLComHandle implements Serializable {
   private static final long serialVersionUID = -401841650L;
   ...
   public ABLComHandle(Long var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLComHandle)) {
         return false;
      } else {
         ABLComHandle var2 = (ABLComHandle)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLComHandle ::");
