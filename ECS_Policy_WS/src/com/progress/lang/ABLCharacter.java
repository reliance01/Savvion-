...
public class ABLCharacter implements Serializable {
   private static final long serialVersionUID = -574609874L;
   ...
   public ABLCharacter(String var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLCharacter)) {
         return false;
      } else {
         ABLCharacter var2 = (ABLCharacter)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLCharacter ::");
