...
public class ABLLogical implements Serializable {
   private static final long serialVersionUID = 782566478L;
   ...
   public ABLLogical(Boolean var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLLogical)) {
         return false;
      } else {
         ABLLogical var2 = (ABLLogical)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLLogical ::");
