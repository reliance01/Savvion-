...
public class ABLRaw implements Serializable {
   ...
   public ABLRaw(Byte[] var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLRaw)) {
         return false;
      } else {
         ABLRaw var2 = (ABLRaw)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLRaw ::");
