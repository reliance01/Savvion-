...
public class ABLHandle implements Serializable {
   private static final long serialVersionUID = 1560570179L;
   ...
   public ABLHandle(Long var1, Boolean var2) {
      this.value = var1;
      this.unknown = var2;
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof ABLHandle)) {
         return false;
      } else {
         ABLHandle var2 = (ABLHandle)var1;
         if (var2 == null) {
            return false;
         } else {
   ...
   public String toString() {
      ...
      var1.append("com.progress.lang.ABLHandle ::");
