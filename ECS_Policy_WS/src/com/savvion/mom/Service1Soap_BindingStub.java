...
public class Service1Soap_BindingStub extends Stub implements Service1Soap_PortType {
   ...
   public Service1Soap_BindingStub() throws AxisFault {
      this((Service)null);
   }

   public Service1Soap_BindingStub(URL endpointURL, Service service) throws AxisFault {
      this(service);
      super.cachedEndpoint = endpointURL;
   }

   public Service1Soap_BindingStub(Service service) throws AxisFault {
