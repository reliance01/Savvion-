...
public class WS_RGICL_ECS_PRODUCT_SETUP_FLOW {
   private static BizLogicManager pak = null;
   private String ptName = "RGICL_ECS_PRODUCT_SETUP_FLOW";
   ...
   public WS_RGICL_ECS_PRODUCT_SETUP_FLOW() {
      NLog.ws.debug("RGICL_ECS_PRODUCT_SETUP_FLOW service invoked");
   }
   ...
   public void PRODUCT_MAKER(String sessionId, String piName, String wiName) throws AxisFault {
      NLog.ws.debug("PRODUCT_MAKER method invoked");
      HashMap dsTypeMap = new HashMap();
      HashMap dsValues = new HashMap();
      Hashtable resolvedDSValues = this.getDSValues(dsTypeMap, dsValues);
   ...
   public void PRODUCTCHECKER(String sessionId, String piName, String wiName) throws AxisFault {
      NLog.ws.debug("PRODUCTCHECKER method invoked");
      HashMap dsTypeMap = new HashMap();
      HashMap dsValues = new HashMap();
      Hashtable resolvedDSValues = this.getDSValues(dsTypeMap, dsValues);
      this.setProcessDataslotValues(sessionId, piName, resolvedDSValues);
   ...
   public ResponseObject Create_WorkFlowForProductSetUp(RequestObject[] reqObj) throws AxisFault {
