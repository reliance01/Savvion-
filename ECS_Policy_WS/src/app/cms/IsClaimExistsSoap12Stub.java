...
public class IsClaimExistsSoap12Stub extends Stub implements IsClaimExistsSoap_PortType {
   ...
   public IsClaimExistsSoap12Stub() throws AxisFault {
      this((Service)null);
   }

   public IsClaimExistsSoap12Stub(URL endpointURL, Service service) throws AxisFault {
      this(service);
      super.cachedEndpoint = endpointURL;
   }

   public IsClaimExistsSoap12Stub(Service service) throws AxisFault {
