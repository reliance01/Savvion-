...
public class AutoAdjudicationOPDCLFlow {
   ...
   public ResponseObject AutoAdjudicationOPDCLFlowTask(RequestObject[] reqObj) {
      ...
      if (reqObj == null) {
         ...
         try {
            ResponseObject res = cl.UpdateAndCompleteOPDCLFlowTask(reqObj);
            ...
            if (res.getResponseCode() == "5000" && res.getResultworkItemArray()[0].getQueue().contains("CLExecutive")) {
               ...
               objInput[4].setKey("CLNO");
               objInput[4].setValue((String)hashMap.get("CLNO"));
               res = cl.UpdateAndCompleteOPDCLFlowTask(objInput);
               if (res.getResponseCode() == "5000") {
            ...
            if (res.getResponseCode() == "5000" && res.getResultworkItemArray()[0].getQueue().contains("CLEditor")) {
               objInput = new RequestObject[5];
               objInput[0] = new RequestObject();
               objInput[0].setKey("PROCESSINSTANCENAME");
               objInput[0].setValue(res.getResultworkItemArray()[0].getPiName());
               ...
               objInput[3].setValue("Approve");
               objInput[4] = new RequestObject();
               objInput[4].setKey("NEEDSEFTCHECK");
               objInput[4].setValue((String)hashMap.get("NEEDSEFTCHECK"));
               res = cl.UpdateAndCompleteOPDCLFlowTask(objInput);
               if (res.getResponseCode() == "5000") {
                  workitem = new WorkItemObject();
                  workitem.setName(objInput[1].getValue());
            ...
            if (res.getResponseCode() == "5000" && res.getResultworkItemArray()[0].getQueue().contains("CLApprover")) {
               objInput = new RequestObject[4];
               objInput[0] = new RequestObject();
               objInput[0].setKey("PROCESSINSTANCENAME");
               objInput[0].setValue(res.getResultworkItemArray()[0].getPiName());
               objInput[1] = new RequestObject();
