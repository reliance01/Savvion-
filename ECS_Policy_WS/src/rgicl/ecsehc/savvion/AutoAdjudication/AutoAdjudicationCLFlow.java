...
public class AutoAdjudicationCLFlow {
   ...
   public AutoAdjudicationCLFlow(String propertiesPath) {
   }
   ...
   public ResponseObject AutoAdjudicationCLFlowTask(RequestObject[] reqObj) {
      ...
      if (reqObj == null) {
         ...
         try {
            ResponseObject res = cl.UpdateAndCompleteCLFlowTask(reqObj);
            ...
            if (res.getResponseCode() == "5000" && res.getResultworkItemArray()[0].getQueue().contains("CLExecutive")) {
               ...
               res = cl.UpdateAndCompleteCLFlowTask(objInput);
               if (res.getResponseCode() == "5000") {
