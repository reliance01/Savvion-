...
public class DBProperties {
   ...
   public DBProperties(String propertiesPath) {
      try {
         this.dblog = Logger.getLogger("dbutils_HCS");
         this.DB_PROPERTIES_FILE = propertiesPath + "/conf/ECS_DATASOURCE_PROPERTIES.properties";
         this.QUERY_PROPERTIES_FILE = propertiesPath + "/conf/ECS_SAVVION_PROPERTIES.properties";
         this.LOG_PROPERTIES_FILE = propertiesPath + "/conf/ECS_SAVVION_LOG_PROPERTIES.properties";
