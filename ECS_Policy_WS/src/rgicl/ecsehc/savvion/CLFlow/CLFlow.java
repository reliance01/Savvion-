package rgicl.ecsehc.savvion.CLFlow;
...
public class CLFlow {
   ...
   public CLFlow(String propertiesPath) {
   }
   ...
   public ResponseObject UpdateAndCompleteCLFlowTask(RequestObject[] reqObj) {
      ...
      if (reqObj == null) {
         ...
         automatictasklog.info("ECS Savvion: " + methodName + " Service:::: hardCopyReceived " + hardCopyReceived);
         ...
         try {
            ...
            try {
               ...
               try {
                  ...
                  automatictasklog.error("Error in getting Already completed task details ", var94);
               }
               ...
               if (workItemName != null && workItemCaseStatus != null && workItemName.contains("Executive") && !workItemCaseStatus.equals("Closed") && !workItemCaseStatus.equals("Terminate") && !workItemCaseStatus.equals("SendBack") && uc.checkNull(hashMap.get("CLNO"))) {
                  automatictasklog.info("ECS Savvion " + methodName + " Service:::: CLNO is null or empty");
                  responseCode = "5021";
                  responseMessage = "INPUT_VALUE_IS_NULL";
               }
                  ...
                  if (userId != null && !userId.equals("")) {
                     if (responseCode == null) {
                        ...
                        if (isQueried != null && isQueried.equals("Yes") && parentCLInwardNo != null && !parentCLInwardNo.equals("")) {
                           automatictasklog.info("ECS Savvion " + methodName + " Service:::: Closing the associated instance for Query Response ");
                           ...
                           try {
                              ...
                              automatictasklog.info("ECS Savvion " + methodName + " Service:::: Closed the associated instance for Query Response and response is " + associatedresObj.getResponseCode());
                           } catch (Exception var93) {
                              associatedresObj.setResponseCode("5047");
                              associatedresObj.setResponseMessage("INVALID_REQUEST");
                              automatictasklog.error("ECS Savvion " + methodName + " Service:::: Catch Exception while getting Query Queue task" + var93.getMessage());
                           }
                           ...
                           try {
                              if (resultArray != null && resultArray.length != 0) {
                                 ...
                                 if ((hasPMTHold == null || hasPMTHold.equals("No")) && (HasPMTOpenTask == null || HasPMTOpenTask.equals("No")) && (hasInvOpenTask == null || hasInvOpenTask.equals("No"))) {
                                    ...
                                    processInstanceName = processInstanceName.substring(associatedPIName.length(), processInstanceName.length());
                                    associatedresObj = uc.completeAssociatedInstance(userId, associatedWIName, associatedPIName);
                                    automatictasklog.info("ECS Savvion " + methodName + " Service:::: closed the associated instance for HardCopy and response is " + associatedresObj.getResponseCode());
                                 }
                              } else {
                              ...
                              associatedresObj.setResponseCode("5047");
                              associatedresObj.setResponseMessage("INVALID_REQUEST");
                              automatictasklog.error("ECS Savvion " + methodName + " Service:::: Catch Exception while getting EditorHold Queue task" + var96.getMessage());
                           }
                        }
                        ...
                        if (associatedresObj != null && associatedresObj.getResponseCode() != "5000") {
                           ...
                           int var111;
                           for(var111 = 0; var111 < var52; ++var111) {
                              winame = var53[var111];
                           ...
                           for(var111 = 0; var111 < var52; ++var111) {
                              ...
                              if (winame != null && winame != "" && winame.contains("CLPaymentRequestor") && !winame.equals(workItemName)) {
                                 automatictasklog.warn("ECS savvion " + methodName + " Service :CLPaymentRequestor task is available, so needsSAPPR will be set to No");
                                 needsSAPPR = "No";
                                 break;
                              }
                           }
                           ...
                           if (blsession == null) {
                              ...
                              if (workItemName.contains("CLInvestigator")) {
                                 ...
                                 String[] var125 = workItemNames;
                                 int var122 = workItemNames.length;

                                 for(int var115 = 0; var115 < var122; ++var115) {
                                    String winame = var125[var115];
                              ...
                              if (workItemName.contains("CLEFTChecker") && workItemCaseStatus.equals("Approve")) {
                                 ...
                                 automatictasklog.info("ECS Savvion: " + methodName + " Service:::: nextAvailableWorkItemNames size:" + nextAvailableWorkItemNames.length);
                                 if (nextAvailableWorkItemNames.length != 0) {
                                    String[] var140 = nextAvailableWorkItemNames;
                                    var135 = nextAvailableWorkItemNames.length;

                                    for(var136 = 0; var136 < var135; ++var136) {
                                       String nextTask = var140[var136];
                              ...
                              int var134;
                              if ((workItemName.contains("PMTRevert") || workItemName.contains("CLAllowanceAccounts")) && hasOpenTask.equals("No")) {
                                 String[] nextAvailableWorkItemNames = db.getNextAvailableTaskNames(processInstanceName);
                                 ...
                                 if (nextAvailableWorkItemNames.length != 0 && nextAvailableWorkItemNames != null) {
                                    String[] var138 = nextAvailableWorkItemNames;
                                    var136 = nextAvailableWorkItemNames.length;

                                    for(var134 = 0; var134 < var136; ++var134) {
                                       String nextTask = var138[var134];
                              ...
                              if (workItemName.contains("CLInvestigator")) {
                                 ...
                                 if (nextAvailableWorkItemNames.length != 0 && nextAvailableWorkItemNames != null) {
                                    var144 = nextAvailableWorkItemNames;
                                    var61 = nextAvailableWorkItemNames.length;

                                    for(var135 = 0; var135 < var61; ++var135) {
                                       nextTask = var144[var135];
                              ...
                              if (workItemName.contains("AmountApprover") || workItemName.contains("Deviator") || workItemName.contains("VerticalHead")) {
                                 try {
                                    Thread.sleep(3000L);
                                 } catch (InterruptedException var89) {
                                    var89.printStackTrace();
                                 }
                              }

                              wiObjects = uc.getNextAvailableTaskList(processInstanceName, nextWorkItemCaseStatus, workItemName, (String)hashMap.get("NEEDSINVESTIGATION"), (String)null, (String)null, (String)hashMap.get("NEEDSPMT"), (String)hashMap.get("PMTHARDSTOP"), needsSAPPR, (String)hashMap.get("HASALLOWANCE"), (String)hashMap.get("HASACCOUNTS"), isExistingApprover);
                              ...
                              if (wiObjects != null && isQueriedCL) {
                                 WorkItemObject[] var142 = wiObjects;
                                 var134 = wiObjects.length;

                                 for(var57 = 0; var57 < var134; ++var57) {
                                    wiObject = var142[var57];
               ...
               e = var97;
               resObj.setResponseCode("5034");
               resObj.setResponseMessage("DS_NAME_INVALID");
               ...
               automatictasklog.error("ECS Savvion: " + methodName + " Service::::Catch Exception:::" + var97);
               if (var97.getMessage().contains("Incorrect userName/password for")) {
                  try {
                     ...
                     pass = p.encrypt(pass);
                     automatictasklog.info("ECS Savvion CLFlow " + methodName + " userId " + userid + " encrypted " + pass);
                  } catch (Exception var87) {
                     automatictasklog.error("ECS Savvion CLFlow: " + methodName + " :: Exception " + var87);
                  }
               }
            }
         } finally {
            try {
               ...
               automatictasklog.error("ECS Savvion: " + methodName + " Service::::Finally Exception:::" + var85);
            }
      ...
      if (reqObj == null) {
         ...
         try {
            ...
            try {
               ...
               automatictasklog.error("ECS Savvion: " + methodName + " Service::::Catch Exception:::" + var37.getMessage());
               if (var37.getMessage().contains("Incorrect userName/password for")) {
                  try {
                     String userid = (String)hashMap.get("USERID");
                     if (e.getMessage().contains("ECSAdmin")) {
                        userid = "ECSAdmin";
                     ...
                     automatictasklog.error("ECS Savvion CLFLOW: " + methodName + " :: Exception " + var35);
                  }
               }
            }
         } finally {
            try {
               ...
               automatictasklog.error("ECS Savvion: " + methodName + " Service::::Finally Exception:::" + var33.getMessage());
            }
         ...
         try {
            ...
            automatictasklog.error("ECS Savvion CLFlow: " + methodName + " :: Exception " + var34);
         }
      }
