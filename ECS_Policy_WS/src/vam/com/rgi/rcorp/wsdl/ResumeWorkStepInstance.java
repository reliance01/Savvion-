...
public class ResumeWorkStepInstance implements Serializable {
   private String session;
   private String piName;
   private String wsName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ResumeWorkStepInstance.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">resumeWorkStepInstance"));
   ...
   public ResumeWorkStepInstance() {
   }

   public ResumeWorkStepInstance(String session, String piName, String wsName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ResumeWorkStepInstance)) {
         return false;
      } else {
         ResumeWorkStepInstance other = (ResumeWorkStepInstance)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
