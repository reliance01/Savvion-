...
public class ResumeProcessInstance implements Serializable {
   private String session;
   private String piName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ResumeProcessInstance.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">resumeProcessInstance"));
   ...
   public ResumeProcessInstance() {
   }

   public ResumeProcessInstance(String session, String piName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ResumeProcessInstance)) {
         return false;
      } else {
         ResumeProcessInstance other = (ResumeProcessInstance)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
