...
public class ReAssignWorkItemFromWIID implements Serializable {
   private String session;
   private long wiid;
   private String performer;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ReAssignWorkItemFromWIID.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">reAssignWorkItemFromWIID"));
   ...
   public ReAssignWorkItemFromWIID() {
   }

   public ReAssignWorkItemFromWIID(String session, long wiid, String performer) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ReAssignWorkItemFromWIID)) {
         return false;
      } else {
         ReAssignWorkItemFromWIID other = (ReAssignWorkItemFromWIID)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
