...
public class GetProcessTemplateDataSlots implements Serializable {
   private String session;
   private String ptName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GetProcessTemplateDataSlots.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">getProcessTemplateDataSlots"));
   ...
   public GetProcessTemplateDataSlots() {
   }

   public GetProcessTemplateDataSlots(String session, String ptName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GetProcessTemplateDataSlots)) {
         return false;
      } else {
         GetProcessTemplateDataSlots other = (GetProcessTemplateDataSlots)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
