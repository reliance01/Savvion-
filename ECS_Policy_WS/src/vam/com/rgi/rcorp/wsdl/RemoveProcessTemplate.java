...
public class RemoveProcessTemplate implements Serializable {
   private String session;
   private String ptName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(RemoveProcessTemplate.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">removeProcessTemplate"));
   ...
   public RemoveProcessTemplate() {
   }

   public RemoveProcessTemplate(String session, String ptName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof RemoveProcessTemplate)) {
         return false;
      } else {
         RemoveProcessTemplate other = (RemoveProcessTemplate)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
