...
public class GetProcessInstanceWorkSteps implements Serializable {
   private String session;
   private String piName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GetProcessInstanceWorkSteps.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">getProcessInstanceWorkSteps"));
   ...
   public GetProcessInstanceWorkSteps() {
   }

   public GetProcessInstanceWorkSteps(String session, String piName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GetProcessInstanceWorkSteps)) {
         return false;
      } else {
         GetProcessInstanceWorkSteps other = (GetProcessInstanceWorkSteps)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
