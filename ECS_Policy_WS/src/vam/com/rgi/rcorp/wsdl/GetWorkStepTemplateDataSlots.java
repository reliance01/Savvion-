...
public class GetWorkStepTemplateDataSlots implements Serializable {
   private String session;
   private String ptName;
   private String wsName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GetWorkStepTemplateDataSlots.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">getWorkStepTemplateDataSlots"));
   ...
   public GetWorkStepTemplateDataSlots() {
   }

   public GetWorkStepTemplateDataSlots(String session, String ptName, String wsName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GetWorkStepTemplateDataSlots)) {
         return false;
      } else {
         GetWorkStepTemplateDataSlots other = (GetWorkStepTemplateDataSlots)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
