...
public class ReAssignWorkItem implements Serializable {
   private String session;
   private String wiName;
   private String performer;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(ReAssignWorkItem.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">reAssignWorkItem"));
   ...
   public ReAssignWorkItem(String session, String wiName, String performer) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof ReAssignWorkItem)) {
         return false;
      } else {
         ReAssignWorkItem other = (ReAssignWorkItem)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
