...
public class DataSlotTemplate implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(DataSlotTemplate.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", "DataSlotTemplate"));
   ...
   public DataSlotTemplate() {
   }

   public DataSlotTemplate(String choices, boolean isReadOnly, boolean isWriteOnly, String name, long ptid, String type, Object value) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof DataSlotTemplate)) {
         return false;
      } else {
         DataSlotTemplate other = (DataSlotTemplate)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
