...
public class GetProcessTemplateXML implements Serializable {
   private String session;
   private String ptName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GetProcessTemplateXML.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">getProcessTemplateXML"));
   ...
   public GetProcessTemplateXML() {
   }

   public GetProcessTemplateXML(String session, String ptName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GetProcessTemplateXML)) {
         return false;
      } else {
         GetProcessTemplateXML other = (GetProcessTemplateXML)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
