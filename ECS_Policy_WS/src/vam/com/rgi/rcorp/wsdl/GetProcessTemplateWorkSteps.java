...
public class GetProcessTemplateWorkSteps implements Serializable {
   private String session;
   private String ptName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GetProcessTemplateWorkSteps.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">getProcessTemplateWorkSteps"));
   ...
   public GetProcessTemplateWorkSteps() {
   }

   public GetProcessTemplateWorkSteps(String session, String ptName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GetProcessTemplateWorkSteps)) {
         return false;
      } else {
         GetProcessTemplateWorkSteps other = (GetProcessTemplateWorkSteps)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
