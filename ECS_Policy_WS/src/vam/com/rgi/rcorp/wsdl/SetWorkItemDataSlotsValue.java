...
public class SetWorkItemDataSlotsValue implements Serializable {
   private String session;
   private String wiName;
   private DataSlotinstance[] dsi;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SetWorkItemDataSlotsValue.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">setWorkItemDataSlotsValue"));
   ...
   public SetWorkItemDataSlotsValue() {
   }

   public SetWorkItemDataSlotsValue(String session, String wiName, DataSlotinstance[] dsi) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SetWorkItemDataSlotsValue)) {
         return false;
      } else {
         SetWorkItemDataSlotsValue other = (SetWorkItemDataSlotsValue)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
            ...
            boolean _equals = (this.session == null && other.getSession() == null || this.session != null && this.session.equals(other.getSession())) && (this.wiName == null && other.getWiName() == null || this.wiName != null && this.wiName.equals(other.getWiName())) && (this.dsi == null && other.getDsi() == null || this.dsi != null && Arrays.equals(this.dsi, other.getDsi()));
