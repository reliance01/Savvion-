...
public class GetProcessTemplateID implements Serializable {
   private String session;
   private String ptName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GetProcessTemplateID.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">getProcessTemplateID"));
   ...
   public GetProcessTemplateID() {
   }

   public GetProcessTemplateID(String session, String ptName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GetProcessTemplateID)) {
         return false;
      } else {
         GetProcessTemplateID other = (GetProcessTemplateID)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
