...
public class SuspendWorkStepInstance implements Serializable {
   private String session;
   private String piName;
   private String wsName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(SuspendWorkStepInstance.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">suspendWorkStepInstance"));
   ...
   public SuspendWorkStepInstance() {
   }

   public SuspendWorkStepInstance(String session, String piName, String wsName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof SuspendWorkStepInstance)) {
         return false;
      } else {
         SuspendWorkStepInstance other = (SuspendWorkStepInstance)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
