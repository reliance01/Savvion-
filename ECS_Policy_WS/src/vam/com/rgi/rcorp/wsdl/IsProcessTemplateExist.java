...
public class IsProcessTemplateExist implements Serializable {
   private String session;
   private String ptName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(IsProcessTemplateExist.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">isProcessTemplateExist"));
   ...
   public IsProcessTemplateExist() {
   }

   public IsProcessTemplateExist(String session, String ptName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof IsProcessTemplateExist)) {
         return false;
      } else {
         IsProcessTemplateExist other = (IsProcessTemplateExist)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
