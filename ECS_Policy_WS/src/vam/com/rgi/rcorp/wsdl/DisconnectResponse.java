...
public class DisconnectResponse implements Serializable {
   ...
   private static TypeDesc typeDesc = new TypeDesc(DisconnectResponse.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">disconnectResponse"));
   }
