...
public class GetProcessInstanceDataSlots implements Serializable {
   private String session;
   private String piName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GetProcessInstanceDataSlots.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">getProcessInstanceDataSlots"));
   ...
   public GetProcessInstanceDataSlots() {
   }

   public GetProcessInstanceDataSlots(String session, String piName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GetProcessInstanceDataSlots)) {
         return false;
      } else {
         GetProcessInstanceDataSlots other = (GetProcessInstanceDataSlots)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
