...
public class GetProcessInstance implements Serializable {
   private String session;
   private String piName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GetProcessInstance.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">getProcessInstance"));
   ...
   public GetProcessInstance(String session, String piName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GetProcessInstance)) {
         return false;
      } else {
         GetProcessInstance other = (GetProcessInstance)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
