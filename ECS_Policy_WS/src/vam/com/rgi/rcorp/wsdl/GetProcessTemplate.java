...
public class GetProcessTemplate implements Serializable {
   private String session;
   private String ptName;
   private Object __equalsCalc = null;
   private boolean __hashCodeCalc = false;
   private static TypeDesc typeDesc = new TypeDesc(GetProcessTemplate.class, true);

   static {
      typeDesc.setXmlType(new QName("http://workflow.webservice.savvion.com", ">getProcessTemplate"));
   ...
   public GetProcessTemplate(String session, String ptName) {
   ...
   public synchronized boolean equals(Object obj) {
      if (!(obj instanceof GetProcessTemplate)) {
         return false;
      } else {
         GetProcessTemplate other = (GetProcessTemplate)obj;
         if (obj == null) {
            return false;
         } else if (this == obj) {
            return true;
