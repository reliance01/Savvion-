...
public class WS_RGICL_ECS_POLICY_FLOW {
   ...
   final String ECSConfigurationPTName;
   ...
   final String USER_ID_NULL;
   final String USER_NOT_AUTHORIZED;
   final String USER_NAME_NULL;
   final String USER_ROLE_NULL;
   final String CLM_NUM_NULL;
   final String CLM_LOB_NULL;
   final String CLM_FLAG_NULL;
   final String CLM_TYPE_NULL;
   final String CLM_REOPEN_NULL;
   final String TPA_FLAG_NULL;
   final String STP_FLAG_NULL;
   final String PI_NAME_NULL;
   final String PI_ID_NULL;
   final String DS_NAME_NULL;
   final String DS_VALUE_NULL;
   final String WINAME_NULL;
   final String REASSGN_BSM_NULL;
   final String APPROVER_USER_ID_NULL;
   final String RESERVE_APPR_FLAG_NULL;
   final String PYMT_APPR_FLAG_NULL;
   final String INPUT_VALUE_IS_NULL;
   final String USER_ALREADY_MAPPED;
   final String USER_NOT_MAPPED;
   final String USER_ID_INVALID;
   final String USER_ROLE_INVALID;
   final String PI_ID_INVALID;
   final String PI_NAME_INVALID;
   final String DS_NAME_INVALID;
   final String DS_VALUE_INVALID;
   final String APPROVER_USER_ID_INVALID;
   final String CLM_FLAG_INVALID;
   final String INVALID_INPUT;
   final String COMMON_INBOX_EMPTY;
   final String ASSIGNED_INBOX_EMPTY;
   final String FAILURE_EXCEPTION;
   final String INVALID_WINAME;
   final String WINAME_NOT_FOUND;
   final String NEXT_WORKITEM_NOT_FOUND;
   final String PENDING_CLAIMS_EMPTY;
   final String DATABASE_ERROR;
   final String ECSGroup;
   final String INVALID_REQUEST;
   final String REQUEST_OBJECT_IS_NULL;
   final String INVALID_LOB;
   final String SUB_PROCESSINSTANCES_EMPTY;
   final String CLMMGRUser;
   final String BSMMGRUser;
   final String RCMMGRUser;
   final String ROMMGRUser;
   final String RAMMGRUser;
   final String COMMGRUser;
   final String COINSURERUser;

   public WS_RGICL_ECS_POLICY_FLOW() {
      this.ECS_SAVVION_PROPERTIES = this.SBM_HOME + "/conf/ECS_SAVVION_PROPERTIES.properties";
      this.ECS_SAVVION_LOG_PROPERTIES = this.SBM_HOME + "/conf/ECS_SAVVION_PHASE1A_LOG_PROPERTIES.properties";
      this.responseCode = null;
      this.ECSConfigurationPTName = "RGICL_ECS_CONFIGURATION_FLOW";
      this.ECSConfigurationInstanceName = "";
      this.priority = "1";
      this.ECSPaymentInstanceName = "";
      this.SUCCESS = "5000";
      this.USER_ID_NULL = "5001";
      this.USER_NOT_AUTHORIZED = "5002";
      this.USER_NAME_NULL = "5003";
      this.USER_ROLE_NULL = "5004";
      this.CLM_NUM_NULL = "5005";
      this.CLM_LOB_NULL = "5006";
      this.CLM_FLAG_NULL = "5007";
      this.CLM_TYPE_NULL = "5008";
      this.CLM_REOPEN_NULL = "5009";
      this.TPA_FLAG_NULL = "5010";
      this.STP_FLAG_NULL = "5011";
      this.PI_NAME_NULL = "5012";
      this.PI_ID_NULL = "5013";
      this.DS_NAME_NULL = "5014";
      this.DS_VALUE_NULL = "5015";
      this.WINAME_NULL = "5016";
      this.REASSGN_BSM_NULL = "5017";
      this.APPROVER_USER_ID_NULL = "5018";
      this.RESERVE_APPR_FLAG_NULL = "5019";
      this.PYMT_APPR_FLAG_NULL = "5020";
      this.INPUT_VALUE_IS_NULL = "5021";
      this.USER_ALREADY_MAPPED = "5022";
      this.USER_NOT_MAPPED = "5023";
      this.USER_ID_INVALID = "5030";
      this.USER_ROLE_INVALID = "5031";
      this.PI_ID_INVALID = "5032";
      this.PI_NAME_INVALID = "5033";
      this.DS_NAME_INVALID = "5034";
      this.DS_VALUE_INVALID = "5035";
      this.APPROVER_USER_ID_INVALID = "5036";
      this.CLM_FLAG_INVALID = "5037";
      this.INVALID_INPUT = "5038";
      this.COMMON_INBOX_EMPTY = "5041";
      this.ASSIGNED_INBOX_EMPTY = "5042";
      this.FAILURE_EXCEPTION = "5050";
      this.INVALID_WINAME = "5059";
      this.WINAME_NOT_FOUND = "5060";
      this.NEXT_WORKITEM_NOT_FOUND = "5043";
      this.PENDING_CLAIMS_EMPTY = "5044";
      this.DATABASE_ERROR = "5045";
      this.ECSGroup = "ECS";
      this.INVALID_REQUEST = "5047";
      this.REQUEST_OBJECT_IS_NULL = "5070";
      this.INVALID_LOB = "5046";
      this.SUB_PROCESSINSTANCES_EMPTY = "SUB_PROCESSINSTANCES_EMPTY";
      this.CLMMGRUser = "CLMMGR";
      this.BSMMGRUser = "BSMMGR";
      this.RCMMGRUser = "RCMMGR";
      this.ROMMGRUser = "ROMMGR";
      this.RAMMGRUser = "RAMMGR";
      this.COMMGRUser = "COMMGR";
      this.COINSURERUser = "COINSURER";
      ...
      try {
         ...
         automatictasklog = Logger.getLogger("Automatic_Phase1A");
         humantasklog = Logger.getLogger("Human_Phase1A");
   ...
   private ResponseObject removeUserFromECSGroup(RequestObject[] reqObj) {
      String result = null;
      boolean status = false;
      AdvanceGroup groupObj = null;
      String responseCode = null;
   ...
   private ResponseObject assignTaskECS(RequestObject[] reqObj) {
   ...
   private ResponseObject makeAvaibaleTaskECS(RequestObject[] reqObj) {
      automatictasklog.info("ECS Savvion: assignTaskECS Service ::START");
      new HashMap();
      HashMap hm = new HashMap();
      String[] workItemName = (String[])null;
   ...
   private ResponseObject getClaimStatusECS(RequestObject[] reqObj) {
   ...
   private ResponseObject Create_WorkFlowForPolicyConfiguration(RequestObject[] reqObj) {
   ...
   private ResponseObject Create_WorkFlowForProductSetUp(RequestObject[] reqObj) {
