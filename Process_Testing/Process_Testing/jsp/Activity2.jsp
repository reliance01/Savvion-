<%--  This JSP has been generated by using from xsl version 9.0 at Mon Mar 07 00:42:40 IST 2022 --%>
<!DOCTYPE html>
...
<%! String __webAppName = "Process_Testing"; %>
...
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="" dso="Sum,Value2,Value1"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="Sum,Value2,Value1"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="Sum,Value2,Value1" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:initApp mode="BizSite" name="Process_Testing"></bizsolo:initApp>
...
<bizsolo:initDS name="Sum" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="Sum,Value2,Value1"></bizsolo:executeAction>
</bizsolo:if>
...
<% try{ %><sbm:setBundle scope="page" basename="Process_Testing/properties/Process_Testing"></sbm:setBundle><% } catch(Exception e){}%>
<bizsolo:getApplicationResources baseName="Process_Testing/properties/Process_Testing"/></head>
...
<sbm:dataSources appName="Process_Testing" appType="bizlogic">
</sbm:dataSources>
<script language="JavaScript">
<!---->
</script>
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'Process_Testing',processType:'bizlogic',maxMultiLineLength:${maxMultiLineLength},adapletCache:{'user':''}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
