...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="Value1,Value2,CallType,ApproverStatus"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="" dso="ApproverStatus,Value2,Value1,CallType"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="ApproverStatus,Value2,Value1,CallType"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="ApproverStatus,Value2,Value1,CallType" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="ApproverStatus" type="STRING" choices="Approve|Reject"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="ApproverStatus,Value2,Value1,CallType"></bizsolo:executeAction>
</bizsolo:if>
...
<input name="_PageName" type="hidden" value="Activity 1">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Activity 1.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <div align="left" id="">
              <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.Activity 1.Value1.label"></sbm:message></Label>
            </div>
          </td>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <div align="left" id="">
        ...
        <tr>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <div align="left" id="">
              <Label class="ApSegDataslotLabel" id="" for="textField2"><sbm:message key="dataslot.Activity 1.Value2.label"></sbm:message></Label>
            </div>
          </td>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <div align="left" id="">
              <sfe:widget name="sbm.textfield" id="textField2" args="{'type':'text', 'size':20, 'maxlength':20, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Aurea Process textfield widget', 'tabOrder':'0'}" />
        ...
        <tr>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <div align="left" id="">
              <Label class="ApSegDataslotLabel" id="" for="textField3"><sbm:message key="dataslot.Activity 1.CallType.label"></sbm:message></Label>
            </div>
          </td>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <div align="left" id="">
              <sfe:widget name="sbm.textfield" id="textField3" args="{'type':'text', 'size':20, 'maxlength':20, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Aurea Process textfield widget', 'tabOrder':'0'}" />
        ...
        <tr>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <div align="left" id="">
              <Label class="ApSegDataslotLabel" id="" for="combobox1"><sbm:message key="dataslot.Activity 1.ApproverStatus.label"></sbm:message></Label>
            </div>
          </td>
          <td align="left" class="ApSegDataVal" id="" style="text-align:left;vertical-align:top" valign="top" rowspan="1" colspan="1">
            <div align="left" id="">
              <sfe:widget name="sbm.combobox" id="combobox1" args="{'size':20, 'readonly':false, 'visible':true, 'disabled':false, 'cascade':false, 'level':0, 'validationType':'none', 'validation':{}, 'toolTip':'Aurea Process Combobox widget', 'tabOrder':'0'}" value="[{'label':'Approve','value':'Approve','selected':false},{'label':'Reject','value':'Reject','selected':false}]" />
...
{widget:'textField3', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'CallType', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'CallType', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("Activity1.jsp")%>';
