...
<%! String _PageName = "LegalTeam IRDA Activity"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="CreativeDocByOnlineTeam,IRDADocByLegalTeam,IRDADate,ticketNo,application,uinNo,category,subCategory,processTime,legalIRDARemarks,onlineFinalCreativeRmks"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="CREATOR" dso="onlineFinalCreativeRmks,legalIRDARemarks,processTime,subCategory,category,uinNo,application,ticketNo,IRDADate,IRDADocByLegalTeam,CreativeDocByOnlineTeam"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="onlineFinalCreativeRmks,legalIRDARemarks,processTime,subCategory,category,uinNo,application,ticketNo,IRDADate,IRDADocByLegalTeam,CreativeDocByOnlineTeam"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="onlineFinalCreativeRmks,legalIRDARemarks,processTime,subCategory,category,uinNo,application,ticketNo,IRDADate,IRDADocByLegalTeam,CreativeDocByOnlineTeam" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="IRDADocByLegalTeam" type="DOCUMENT"></bizsolo:initDS>
...
<bizsolo:initDS name="legalIRDARemarks" type="STRING"></bizsolo:initDS>
<bizsolo:initDS name="onlineFinalCreativeRmks" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="onlineFinalCreativeRmks,legalIRDARemarks,processTime,subCategory,category,uinNo,application,ticketNo,CREATOR,IRDADate,IRDADocByLegalTeam,CreativeDocByOnlineTeam"></bizsolo:executeAction>
</bizsolo:if>

<title>LegalTeam IRDA Activity</title>
...
<input name="_PageName" type="hidden" value="LegalTeam IRDA Activity">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.LegalTeam IRDA Activity.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<div class='header'>Legal Team IRDA Activity</div>
          </td>
        </tr>
      </tbody>
    </table>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2_V1" width="100%">
   ...
   Online Team Filing Creative Remark : 
...
<%
  ...
  String rmks = bean.getPropString("onlineFinalCreativeRmks");
...
%>
   ...
   Filing Creative Docs :

</span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document1"><bizsolo:getDS type="field" name="CreativeDocByOnlineTeam" multiline="true" wsName="LegalTeam IRDA Activity" appendWith="false"></bizsolo:getDS></div>
...
%>
          ...
          <td class="(default)" id="" rowspan="1" colspan="1"></td>
          <td class="(default)" id="" rowspan="1" colspan="1"></td>
        </tr>
      </tbody>
    </table>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table4" width="100%">
  ...
  Attach your Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="IRDADocByLegalTeam" multiline="true" wsName="LegalTeam IRDA Activity" appendWith="false"></bizsolo:getDS></div>
...
<sfe:widget name="sbm.textfield" id="textField1" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':true, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="irdaRmks" args="{'type':'text', 'size':20, 'maxlength':2000, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <input class="ApScrnButton" name="bizsite_completeTask" id="done" type="submit" tabindex="0" value="<sbm:message key='LegalTeam IRDA Activity.done.label'/>" onClick="return button1_onClick();clickedButton=this.name;this.onsubmit = new Function('return false');" onMouseOut="this.className='ApScrnButton';" onMouseOver="this.className='ApScrnButtonHover';">
...
var abc ="IRDA Date should not be future date.";
Ext.MessageBox.alert("Select IRDA Date", abc, null);
}
...
{widget:'textField1', bound:'true', editable:'false', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'CREATOR', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'', dataSlotType:''}, dsType:'STRING', service:'false'},
{widget:'textField2', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ticketNo', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'ticketNo', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'textField8', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'uinNo', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'uinNo', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField4', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'category', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'category', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField5', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'subCategory', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'subCategory', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'irdaRmks', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'legalIRDARemarks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'legalIRDARemarks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField7', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'onlineFinalCreativeRmks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'onlineFinalCreativeRmks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'}
];
var businessObjects = [];
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("LegalTeamIRDAActivity.jsp")%>';
