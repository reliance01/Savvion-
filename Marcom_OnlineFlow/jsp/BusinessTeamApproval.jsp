<%--  This JSP has been generated by using from xsl version 9.0 at Wed Mar 09 17:54:27 IST 2022 --%>
<!DOCTYPE html>
...
<%! String _PageName = "BusinessTeam Approval"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="marcomTeamUpload,businessTeamDocs,businessTeamRmks,businessTeamApproval,ticketNo,uinNo,processTime,application,category,subCategory,priorty,marcomRmks"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="marcomTeamUpload" dso="businessTeamDocs,businessTeamRmks,businessTeamApproval,ticketNo,uinNo,processTime,application,category,subCategory,priorty,marcomRmks"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="businessTeamDocs,businessTeamRmks,businessTeamApproval,ticketNo,uinNo,processTime,application,category,subCategory,priorty,marcomRmks"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="businessTeamDocs,businessTeamRmks,businessTeamApproval,ticketNo,uinNo,processTime,application,category,subCategory,priorty,marcomRmks" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="marcomRmks" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="marcomTeamUpload,businessTeamDocs,businessTeamRmks,businessTeamApproval,ticketNo,uinNo,processTime,application,category,subCategory,priorty,marcomRmks"></bizsolo:executeAction>
</bizsolo:if>

<title>BusinessTeam Approval</title>
...
<input name="_PageName" type="hidden" value="BusinessTeam Approval">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.BusinessTeam Approval.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<div class='header'>Business Team Activity</div>
    <br clear="all">
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2_V1_V1" width="100%">
  ...
  <%= bean.getPropString("priorty") %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document2_V1"><bizsolo:getDS type="field" name="marcomTeamUpload" multiline="true" wsName="BusinessTeam Approval" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2" width="100%">
  ...
  <textarea cols='30' rows='2' id='rmks'></textarea>
   ...
   Attach your Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="businessTeamDocs" multiline="true" wsName="BusinessTeam Approval" appendWith="false"></bizsolo:getDS></div>
...
<div style='display:none;'>
    <br clear="all">
<sfe:widget name="sbm.textfield" id="BTRmks" args="{'type':'text', 'size':20, 'maxlength':2000, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
...
var allWidgets = [{widget:'BTRmks', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'businessTeamRmks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'businessTeamRmks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'status', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'businessTeamApproval', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'businessTeamApproval', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField3', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ticketNo', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'ticketNo', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField1', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'uinNo', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'uinNo', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField4', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'processTime', dataSlotType:'LONG'}, target:{type:'DATASLOT', dataSlotName:'processTime', dataSlotType:'LONG'}, dsType:'LONG', service:'false'},
{widget:'textField5', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'application', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'application', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField6', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'category', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'category', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'textField9', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'marcomRmks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'marcomRmks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'}
];
var businessObjects = [];
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'Marcom_OnlineFlow',processType:'bizlogic',maxMultiLineLength:${maxMultiLineLength},adapletCache:{'user':''}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("BusinessTeamApproval.jsp")%>';
