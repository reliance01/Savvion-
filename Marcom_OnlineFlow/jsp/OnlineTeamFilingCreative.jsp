...
<%! String _PageName = "OnlineTeam Filing Creative"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="userUpload,onlineTeamUpload,uwDocs,legalDocs,CreativeDocByOnlineTeam,category,onlineTeamRmks,ticketNo,processTime,userRemarks,priorty,uinNo,application,subCategory,onlineFinalCreativeRmks,uwRemarks,legalRemarks,commTyp,skipUWTask"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="CREATOR,legalDocs,uwDocs,onlineTeamUpload,userUpload" dso="skipUWTask,commTyp,legalRemarks,uwRemarks,onlineFinalCreativeRmks,subCategory,application,uinNo,priorty,userRemarks,processTime,ticketNo,onlineTeamRmks,category,CreativeDocByOnlineTeam"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="skipUWTask,commTyp,legalRemarks,uwRemarks,onlineFinalCreativeRmks,subCategory,application,uinNo,priorty,userRemarks,processTime,ticketNo,onlineTeamRmks,category,CreativeDocByOnlineTeam"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="skipUWTask,commTyp,legalRemarks,uwRemarks,onlineFinalCreativeRmks,subCategory,application,uinNo,priorty,userRemarks,processTime,ticketNo,onlineTeamRmks,category,CreativeDocByOnlineTeam" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="CreativeDocByOnlineTeam" type="DOCUMENT"></bizsolo:initDS>
...
<bizsolo:initDS name="onlineFinalCreativeRmks" type="STRING"></bizsolo:initDS>
...
<bizsolo:initDS name="skipUWTask" type="BOOLEAN"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="skipUWTask,commTyp,legalRemarks,uwRemarks,onlineFinalCreativeRmks,subCategory,application,uinNo,priorty,userRemarks,processTime,ticketNo,onlineTeamRmks,category,CREATOR,CreativeDocByOnlineTeam,legalDocs,uwDocs,onlineTeamUpload,userUpload"></bizsolo:executeAction>
</bizsolo:if>

<title>OnlineTeam Filing Creative</title>
...
<input name="_PageName" type="hidden" value="OnlineTeam Filing Creative">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.OnlineTeam Filing Creative.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<div class='header'>Online Team Filing Creative Activity</div>
          </td>
        </tr>
      </tbody>
    </table>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2_V1" width="100%">
  ...
  <%= com.rgicl.marcom.BasicUtility.getNameOfUser(bean.getPropString("CREATOR")) %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document1_V1"><bizsolo:getDS type="field" name="userUpload" multiline="true" wsName="OnlineTeam Filing Creative" appendWith="false" writePerm="false"></bizsolo:getDS></div>
  ...
  <%= bean.getPropString("userRemarks") %>
    ...
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table3_V1" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
  ...
  <%= bean.getPropString("priorty") %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="onlineTeamUpload" multiline="true" wsName="OnlineTeam Filing Creative" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
%>
  ...
  U/W Attached Docs :
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document3"><bizsolo:getDS type="field" name="uwDocs" multiline="true" wsName="OnlineTeam Filing Creative" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
%>
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table4_V1" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
...
<%
  String rmks2 = bean.getPropString("legalRemarks");
...
%>
  ...
  Legal Team Attached Docs :

</span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document4"><bizsolo:getDS type="field" name="legalDocs" multiline="true" wsName="OnlineTeam Filing Creative" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2" width="100%">
   ...
   Upload Updated Creatives & More : 

</span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document1"><bizsolo:getDS type="field" name="CreativeDocByOnlineTeam" multiline="true" wsName="OnlineTeam Filing Creative" appendWith="false"></bizsolo:getDS></div>
...
<sfe:widget name="sbm.textfield" id="textField3" args="{'type':'text', 'size':20, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="onlineTeamRmks" args="{'type':'text', 'size':20, 'maxlength':2000, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="textField11" args="{'type':'text', 'size':20, 'maxlength':2000, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="textField12" args="{'type':'text', 'size':20, 'maxlength':2000, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="commType" args="{'type':'text', 'size':20, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
...
$(document).ready(function(){
  var commTypVal = $('#commType').val();
  if(commTypVal == 'Internal Communication')
  {
      $('#button1').val('Close Ticket');
  }
});
...
{widget:'textField9', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'onlineTeamRmks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'onlineTeamRmks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'textField5', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'processTime', dataSlotType:'LONG'}, target:{type:'DATASLOT', dataSlotName:'processTime', dataSlotType:'LONG'}, dsType:'LONG', service:'false'},
{widget:'textField7', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'userRemarks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'userRemarks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField8', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'priorty', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'priorty', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField10', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'uinNo', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'uinNo', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField3', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'application', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'application', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField6', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'subCategory', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'subCategory', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'onlineTeamRmks', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'onlineFinalCreativeRmks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'onlineFinalCreativeRmks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField11', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'uwRemarks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'uwRemarks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField12', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'legalRemarks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'legalRemarks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'commType', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'commTyp', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'commTyp', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("OnlineTeamFilingCreative.jsp")%>';
