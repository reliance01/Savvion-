...
<%! String _PageName = "Procurement Confirmation"; %>
<%! String __webAppName = "Marcom_OnlineFlow"; %>
<% pageContext.setAttribute( "contextPath", request.getContextPath()+"/"); %>
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="mrcWaterMark,mrcSendToProcDoc,mrcBUProcDocs,application,category,processTime,subCategory,ticketNo,mrcWtrMrkRmk,mrcBUProcRmks,mrcSendToProcRmks,uinNo"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="mrcSendToProcDoc,mrcWaterMark" dso="uinNo,mrcSendToProcRmks,mrcBUProcRmks,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcBUProcDocs"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="uinNo,mrcSendToProcRmks,mrcBUProcRmks,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcBUProcDocs"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="uinNo,mrcSendToProcRmks,mrcBUProcRmks,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcBUProcDocs" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="uinNo,mrcSendToProcRmks,mrcBUProcRmks,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcBUProcDocs,mrcSendToProcDoc,mrcWaterMark"></bizsolo:executeAction>
</bizsolo:if>

<title>Procurement Confirmation</title>
<!-- Javascript -->
...
<input name="_PageName" type="hidden" value="Procurement Confirmation">
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table1_V1" width="100%">
      <tbody>
        <tr>
          ...
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="document1"><bizsolo:getDS type="field" name="mrcWaterMark" multiline="true" wsName="Procurement Confirmation" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table1_V1_V1_V3" width="100%">
      <tbody>
        <tr>
          ...
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="document4"><bizsolo:getDS type="field" name="mrcSendToProcDoc" multiline="true" wsName="Procurement Confirmation" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table1_V1_V1" width="100%">
      <tbody>
        <tr>
          ...
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="mrcBUProcDocs" multiline="true" wsName="Procurement Confirmation" appendWith="false"></bizsolo:getDS></div>
...
<input class="ApInptTxt" type="text" id="textField2" name="application" size="30" maxlength="256" value="<bizsolo:value name='application'/>">
    ...
    <br clear="all">
<input class="ApInptTxt" type="text" id="BURmks" name="mrcBUProcRmks" size="20" maxlength="2000" value="<bizsolo:value name='mrcBUProcRmks'/>">
    <div style="display:none" id="BURmksError"><div><font color="red"><span class="error" id="BURmksErrorMsg"></span><a href="#" onclick="BURmksErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("ProcurementConfirmation.jsp")%>';
