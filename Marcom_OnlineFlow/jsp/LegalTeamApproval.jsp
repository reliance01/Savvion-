<%--  This JSP has been generated by using from xsl version 9.0 at Wed Mar 09 17:54:26 IST 2022 --%>
<!DOCTYPE html>
...
<%! String _PageName = "LegalTeam Approval"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="userUpload,marcomTeamUpload,uwDocs,legalDocs,application,category,priorty,processTime,subCategory,ticketNo,userRemarks,uwRemarks,legalRemarks,legalApprovalStatus,marcomRmks,uinNo,commTyp"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="userUpload,marcomTeamUpload,uwDocs,CREATOR" dso="legalDocs,application,category,priorty,processTime,subCategory,ticketNo,userRemarks,uwRemarks,legalRemarks,legalApprovalStatus,marcomRmks,uinNo,commTyp"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="legalDocs,application,category,priorty,processTime,subCategory,ticketNo,userRemarks,uwRemarks,legalRemarks,legalApprovalStatus,marcomRmks,uinNo,commTyp"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="legalDocs,application,category,priorty,processTime,subCategory,ticketNo,userRemarks,uwRemarks,legalRemarks,legalApprovalStatus,marcomRmks,uinNo,commTyp" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="marcomTeamUpload" type="DOCUMENT"></bizsolo:initDS>
...
<bizsolo:initDS name="marcomRmks" type="STRING"></bizsolo:initDS>
<bizsolo:initDS name="uinNo" type="STRING"></bizsolo:initDS>
<bizsolo:initDS name="commTyp" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="userUpload,marcomTeamUpload,uwDocs,legalDocs,CREATOR,application,category,priorty,processTime,subCategory,ticketNo,userRemarks,uwRemarks,legalRemarks,legalApprovalStatus,marcomRmks,uinNo,commTyp"></bizsolo:executeAction>
</bizsolo:if>

<title>LegalTeam Approval</title>
...
<input name="_PageName" type="hidden" value="LegalTeam Approval">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.LegalTeam Approval.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<div class='header'>
   Legal Team Activity
    ...
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataVal" id="table1_V1" width="100%">
      <tbody>
        <tr>
...
%>
    ...
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2_V1" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
  ...
  <%= com.rgicl.marcom.BasicUtility.getNameOfUser(bean.getPropString("CREATOR")) %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document1_V1"><bizsolo:getDS type="field" name="userUpload" multiline="true" wsName="LegalTeam Approval" appendWith="false" writePerm="false"></bizsolo:getDS></div>
  ...
  <%= bean.getPropString("userRemarks") %>
    ...
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2_V1_V1" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
  ...
  <%= bean.getPropString("priorty") %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldName'>Marcom Team Attached Docs : </span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document2_V1"><bizsolo:getDS type="field" name="marcomTeamUpload" multiline="true" wsName="LegalTeam Approval" appendWith="false" writePerm="false"></bizsolo:getDS></div>
        ...
        <tr>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldNameBig'>Marcom Team Remark : </span>
          </td>
          <td class="ApSegDataVal" colspan="3" id="" rowspan="1">
            <span class='fieldValueBig'>
  <%
  String rmks = bean.getPropString("marcomRmks");
...
%>
  ...
  U/W attached Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document3"><bizsolo:getDS type="field" name="uwDocs" multiline="true" wsName="LegalTeam Approval" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table6" width="100%">
  ...
  Attach your Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document4"><bizsolo:getDS type="field" name="legalDocs" multiline="true" wsName="LegalTeam Approval" appendWith="false"></bizsolo:getDS></div>
...
<select id='approvalStatus' onChange='setApprovalStatus();'>
   ...
   <option value='Rework'>Rework</option>
    ...
    <div id='commTypeDiv' style='display:none;'>
    <br clear="all">
...
<sfe:widget name="sbm.textfield" id="textField1" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':true, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="textField2" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="textField3" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="textField5" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="textField7" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="textField8" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="textField9" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="textField10" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="legalRmks" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="legalapprovalStatus" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="commniType" args="{'type':'text', 'size':20, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
...
{
  $('#legalapprovalStatus').val($('#approvalStatus').val());  
  if($('#approvalStatus').val() == 'Approve')
  {
    $('#commTypeDiv').css('display','block');
  }
  else
  {
    $('#commTypeDiv').css('display','none');
  }
}
...
{
  var commVal = $('#commTyp').val();
  if(commVal == '' || commVal == 'Select' || commVal == null)
  {
...
{widget:'textField4', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'marcomRmks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'marcomRmks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'commniType', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'commTyp', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'commTyp', dataSlotType:'STRING'}, dsType:'STRING', service:'false'}
];
var businessObjects = [];
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("LegalTeamApproval.jsp")%>';
