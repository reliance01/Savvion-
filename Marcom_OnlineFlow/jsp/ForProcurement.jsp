...
<%! String _PageName = "For Procurement"; %>
<%! String __webAppName = "Marcom_OnlineFlow"; %>
<% pageContext.setAttribute( "contextPath", request.getContextPath()+"/"); %>
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="mrcWaterMark,mrcSendToProcDoc,mrcProcDocs,mrcBUProcDocs,application,category,processTime,subCategory,ticketNo,mrcWtrMrkRmk,uinNo,mrcAssignTo,mrcBUProcRmks,mrcProcRmks,ticketComplete,mrcSendToProcRmks"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="mrcBUProcDocs,mrcProcDocs,mrcWaterMark" dso="mrcSendToProcRmks,ticketComplete,mrcProcRmks,mrcBUProcRmks,mrcAssignTo,uinNo,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcSendToProcDoc"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="mrcSendToProcRmks,ticketComplete,mrcProcRmks,mrcBUProcRmks,mrcAssignTo,uinNo,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcSendToProcDoc"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="mrcSendToProcRmks,ticketComplete,mrcProcRmks,mrcBUProcRmks,mrcAssignTo,uinNo,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcSendToProcDoc" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:initDS name="mrcBUProcDocs" type="DOCUMENT"></bizsolo:initDS>
    ...
    <bizsolo:initDS name="mrcAssignTo" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="mrcBUProcRmks" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="mrcProcRmks" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="ticketComplete" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="mrcSendToProcRmks" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="mrcSendToProcRmks,ticketComplete,mrcProcRmks,mrcBUProcRmks,mrcAssignTo,uinNo,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcBUProcDocs,mrcProcDocs,mrcSendToProcDoc,mrcWaterMark"></bizsolo:executeAction>
</bizsolo:if>

<title>For Procurement</title>
<!-- Javascript -->
...
<input name="_PageName" type="hidden" value="For Procurement">
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table1_V1" width="100%">
      <tbody>
        <tr>
          ...
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="document1"><bizsolo:getDS type="field" name="mrcWaterMark" multiline="true" wsName="For Procurement" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table1_V1_V1_V3" width="100%">
      <tbody>
        <tr>
          ...
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="document4"><bizsolo:getDS type="field" name="mrcSendToProcDoc" multiline="true" wsName="For Procurement" appendWith="false"></bizsolo:getDS></div>
...
<font color="#000000">
      <%
   long piid = Long.parseLong(activityName.split("#")[1].split("::")[0]);
   com.rgicl.marcom.Utility obj = new com.rgicl.marcom.Utility();
   if(obj.isWSCompleted(piid,"Procurement Requirement"))
   {
%>
    </font>
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table1_V1_V1" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <font color="#000000" face="Times New Roman" size="2">
              <b>Procurement Team Document:</b>
            </font>
          </td>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="mrcProcDocs" multiline="true" wsName="For Procurement" appendWith="false" writePerm="false"></bizsolo:getDS></div>


          </td>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <font color="#000000" face="Times New Roman" size="2">
              <b>Procurement Team Remarks :</b>
            </font>
          </td>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <%
  String rmks1 = bean.getPropString("mrcProcRmks");
...
<font color="#000000">
  ...
  if(obj.isWSCompleted(piid,"Procurement Confirmation"))
  {
%>
    </font>
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table1_V1_V1_V1" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <font color="#000000" face="Times New Roman" size="2">
              <b>Business Team Document:</b>
            </font>
          </td>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="document3"><bizsolo:getDS type="field" name="mrcBUProcDocs" multiline="true" wsName="For Procurement" appendWith="false" writePerm="false"></bizsolo:getDS></div>


          </td>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <font color="#000000" face="Times New Roman" size="2">
              <b>Business Team Remarks :</b>
            </font>
          </td>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <%
  String rmks2 = bean.getPropString("mrcBUProcRmks");
  if(rmks2 != null && rmks2.trim().length()>0)
  {
    out.println(rmks2);
  }
%>
...
<font color="#000000">
 ...
 if(obj.isWSCompleted(piid,"Procurement Requirement") && obj.isWSCompleted(piid,"Procurement Confirmation"))
  {
%>
<br/>
<table width='100%'>
...
<td>
<select id='closeTicket' onChange='CloseTicket_OnChange();'>
...
%>
    ...
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table1_V1_V1_V2" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top">
            <font color="#000000" face="Times New Roman" size="2">
   ...
   <option value='Business User'>Business User</option>
          ...
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top"></td>
          <td class="ApSegDataVal" width="25%" rowspan="1" colspan="1" valign="top"></td>
        </tr>
      </tbody>
    </table>
...
<script>
  ...
  $('#mrcAssignTo').val('Select');

  $('#mrcAssignTo').attr('disabled',true);
...
<input class="ApInptTxt" type="text" id="textField2" name="application" size="30" maxlength="256" value="<bizsolo:value name='application'/>">
    ...
    <input class="ApInptTxt" type="text" id="textField5" name="uinNo" size="20" maxlength="256" value="<bizsolo:value name='uinNo'/>">
    ...
    <br clear="all">
<input class="ApInptTxt" type="text" id="assignee" name="mrcAssignTo" size="20" maxlength="256" value="<bizsolo:value name='mrcAssignTo'/>">
    <div style="display:none" id="assigneeError"><div><font color="red"><span class="error" id="assigneeErrorMsg"></span><a href="#" onclick="assigneeErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
    <input class="ApInptTxt" type="text" id="textField1" name="mrcBUProcRmks" size="20" maxlength="2000" value="<bizsolo:value name='mrcBUProcRmks'/>">
    ...
    <input class="ApInptTxt" type="text" id="textField4" name="mrcProcRmks" size="20" maxlength="2000" value="<bizsolo:value name='mrcProcRmks'/>">
    ...
    <input class="ApInptTxt" type="text" id="completeTicket" name="ticketComplete" size="20" maxlength="256" value="<bizsolo:value name='ticketComplete'/>">
    <div style="display:none" id="completeTicketError"><div><font color="red"><span class="error" id="completeTicketErrorMsg"></span><a href="#" onclick="completeTicketErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
    <input class="ApInptTxt" type="text" id="remarks" name="mrcSendToProcRmks" size="20" maxlength="2000" value="<bizsolo:value name='mrcSendToProcRmks'/>">
    <div style="display:none" id="remarksError"><div><font color="red"><span class="error" id="remarksErrorMsg"></span><a href="#" onclick="remarksErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
    <br clear="all">
<font color="#000000">
      </div>
    </font>
...
function CloseTicket_OnChange()
{
  var val = $('#closeTicket').val();
  if(val == 'Yes' || val == 'Select')
  {
    $('#mrcAssignTo').val('Select');
    $('#mrcAssignTo').attr('disabled',true);
  }
  else if($('#closeTicket').val() == 'No')
  {
    $('#mrcAssignTo').attr('disabled',false);
  }
}
...
{
if('<%=obj.isWSCompleted(piid,"Procurement Requirement")%>' == 'false' || '<%=obj.isWSCompleted(piid,"Procurement Confirmation")%>' == 'false')
{
var assignVal = $('#mrcAssignTo').val();
if(assignVal == 'Select' || assignVal == '')
{
  $('#mrcAssignTo').focus();
  return false;
}
...
{
  if($('#closeTicket').val() == 'Select')
  {
    alert('Please select option.');
    $('#closeTicket').focus();
    return false;
  }
  if($('#closeTicket').val() == 'No')
  {
   if($('#mrcAssignTo').val() == 'Select')
    {
     $('#mrcAssignTo').focus();
     return false;
    }
...
$('#completeTicket').val($('#closeTicket').val());
$('#assignee').val($('#mrcAssignTo').val());
var rmks = $('#rmks').val();
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("ForProcurement.jsp")%>';
