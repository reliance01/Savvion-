...
<%! String _PageName = "BA Circulation"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="circulationDate,ticketNo,application,category,subCategory,uinNo,processTime"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="" dso="processTime,uinNo,subCategory,category,application,ticketNo,circulationDate"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="processTime,uinNo,subCategory,category,application,ticketNo,circulationDate"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="processTime,uinNo,subCategory,category,application,ticketNo,circulationDate" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="circulationDate" type="DATETIME"></bizsolo:initDS>
...
<bizsolo:initDS name="processTime" type="LONG"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="processTime,uinNo,subCategory,category,application,ticketNo,circulationDate"></bizsolo:executeAction>
</bizsolo:if>

<title>BA Circulation</title>
...
<input name="_PageName" type="hidden" value="BA Circulation">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.BA Circulation.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<div class='header'>
   ...
   Business User Circulation Activity
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataVal" id="table1_V1_V1" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldName'>Enter Circulation Date : </span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
...
<sfe:widget name="sbm.textfield" id="textField1" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <input class="ApScrnButton" name="bizsite_completeTask" id="done" type="submit" tabindex="0" value="<bizsolo:getLabel name='COMPLETE_LABEL' type='RESOURCE'/>" onClick="return done_onClick();clickedButton=this.name;this.onsubmit = new Function('return false');" onMouseOut="this.className='ApScrnButton';" onMouseOver="this.className='ApScrnButtonHover';">
...
var abc ="Date should be greater than or equal to Today date.";
...
if(!checkValidDate(document.getElementById('dateTime1').value))
{
 ...
 function done_onClick(eventContext){
{
if($('#dateTime1').val().trim() == '')
{
    alert('Please Select Circulation Date.');
    return false;
};
}}
...
var allWidgets = [{widget:'dateTime1', bound:'true', editable:'true', type:'form.datetime', source: {type:'DATASLOT', dataSlotName:'circulationDate', dataSlotType:'DATETIME'}, target:{type:'DATASLOT', dataSlotName:'circulationDate', dataSlotType:'DATETIME'}, dsType:'DATETIME', service:'false'},
{widget:'textField1', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ticketNo', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'ticketNo', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'textField4', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'subCategory', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'subCategory', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField5', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'uinNo', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'uinNo', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("BACirculation.jsp")%>';
