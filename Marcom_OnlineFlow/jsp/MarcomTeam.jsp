...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="userUpload,businessTeamDocs,uwDocs,legalDocs,marcomTeamUpload,application,category,subCategory,ticketNo,userRemarks,mrcCreativeAssignTo,uinNo,underwriters,processTime,priorty,marcomRmks,legalApprovalStatus,uwGrpName,uwRemarks,uwApprovalStatus,legalRemarks,businessTeamApproval,businessTeamRmks"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="CREATOR,legalDocs,uwDocs,businessTeamDocs,userUpload" dso="businessTeamRmks,businessTeamApproval,legalRemarks,uwApprovalStatus,uwRemarks,uwGrpName,legalApprovalStatus,marcomRmks,priorty,processTime,underwriters,uinNo,mrcCreativeAssignTo,userRemarks,ticketNo,subCategory,category,application,marcomTeamUpload"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="businessTeamRmks,businessTeamApproval,legalRemarks,uwApprovalStatus,uwRemarks,uwGrpName,legalApprovalStatus,marcomRmks,priorty,processTime,underwriters,uinNo,mrcCreativeAssignTo,userRemarks,ticketNo,subCategory,category,application,marcomTeamUpload"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="businessTeamRmks,businessTeamApproval,legalRemarks,uwApprovalStatus,uwRemarks,uwGrpName,legalApprovalStatus,marcomRmks,priorty,processTime,underwriters,uinNo,mrcCreativeAssignTo,userRemarks,ticketNo,subCategory,category,application,marcomTeamUpload" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="businessTeamDocs" type="DOCUMENT"></bizsolo:initDS>
...
<bizsolo:initDS name="mrcCreativeAssignTo" type="STRING"></bizsolo:initDS>
...
<bizsolo:initDS name="businessTeamApproval" type="STRING"></bizsolo:initDS>
<bizsolo:initDS name="businessTeamRmks" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="businessTeamRmks,businessTeamApproval,legalRemarks,uwApprovalStatus,uwRemarks,uwGrpName,CREATOR,legalApprovalStatus,marcomRmks,priorty,processTime,underwriters,uinNo,mrcCreativeAssignTo,userRemarks,ticketNo,subCategory,category,application,marcomTeamUpload,legalDocs,uwDocs,businessTeamDocs,userUpload"></bizsolo:executeAction>
</bizsolo:if>

<title>MarcomTeam</title>
...
<input name="_PageName" type="hidden" value="MarcomTeam">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.MarcomTeam.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<link rel='stylesheet' href='style/custom.css' />
  ...
  <div class='header'>Marcom Team Activity</div>
    <br clear="all">
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2_V1" width="100%">
  ...
  <%= com.rgicl.marcom.BasicUtility.getNameOfUser(bean.getPropString("CREATOR")) %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document1_V1"><bizsolo:getDS type="field" name="userUpload" multiline="true" wsName="MarcomTeam" appendWith="false" writePerm="false"></bizsolo:getDS></div>
  ...
  <%= bean.getPropString("userRemarks") %>
   ...
   String businessTeamApproval = bean.getPropString("businessTeamApproval");
 if(uwApprovalStatusVal == null && businessTeamApproval != null)
   {
     String businessTeamRmks = bean.getPropString("businessTeamRmks");
     if(businessTeamRmks != null && businessTeamRmks.trim().length()>0)
      {
%>
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table7_V2" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldNameBig'>

   User Approval Remark : 
...
%>
  ...
  User attached Doc for Approval : 

</span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document5"><bizsolo:getDS type="field" name="businessTeamDocs" multiline="true" wsName="MarcomTeam" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
%>
  ...
  U/W attached Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document3"><bizsolo:getDS type="field" name="uwDocs" multiline="true" wsName="MarcomTeam" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
%>
   ...
   Legal Team Attached Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document4"><bizsolo:getDS type="field" name="legalDocs" multiline="true" wsName="MarcomTeam" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<select id='priory' onChange='setPriority();'>
  ...
  <option value='Low'>Low</option>
   ...
   Attach your Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="marcomTeamUpload" multiline="true" wsName="MarcomTeam" appendWith="false"></bizsolo:getDS></div>
   ...
   <textarea cols='30' rows='2' id='rmks'></textarea>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <font face="Times New Roman" size="2">
              <b>
                <%
  String businessTeamApprovalVal = bean.getPropString("businessTeamApproval");
  if(businessTeamApprovalVal != null && businessTeamApprovalVal.equals("Approve") && (legalApprovalStatusVal == null || !legalApprovalStatusVal.equals("Rework")))
   {
%>
...
<div style='display:none;'>
    <br clear="all">
<sfe:widget name="sbm.textfield" id="textField1" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="textField4" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="mrcAssignTo" args="{'type':'text', 'size':20, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <input class="ApScrnButton" name="bizsite_completeTask" id="done" type="submit" tabindex="0" value="<sbm:message key='MarcomTeam.done.label'/>" onClick="return button1_onClick();clickedButton=this.name;this.onsubmit = new Function('return false');" onMouseOut="this.className='ApScrnButton';" onMouseOver="this.className='ApScrnButtonHover';">

    <input class="ApScrnButton" name="Submit1323" id="cnl" type="button" tabindex="0" value="<sbm:message key='MarcomTeam.cnl.label'/>" onMouseOut="this.className='ApScrnButton';" onMouseOver="this.className='ApScrnButtonHover';" onClick="sbm.utils.cancel();">
...
<sfe:widget name="form.datetime" id="dateTime1" args="{'dateonly':false, 'visible':true, 'readonly':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="priority" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="mrcRmks" args="{'type':'text', 'size':20, 'maxlength':2000, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="uwGrpName" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
...
{
  if('<%=businessTeamApprovalVal%>' == 'Approve' && '<%=legalApprovalStatusVal%>' != 'Rework')
   {
...
{widget:'mrcAssignTo', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'mrcCreativeAssignTo', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'mrcCreativeAssignTo', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'mrcRmks', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'marcomRmks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'marcomRmks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'textField11', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'businessTeamApproval', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'businessTeamApproval', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField12', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'businessTeamRmks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'businessTeamRmks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'}
];
var businessObjects = [];
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("MarcomTeam.jsp")%>';
