...
<%! String _PageName = "Creative Filing"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="mrcWaterMark,IRDADate,mrcLegalFilingDoc,application,category,processTime,subCategory,ticketNo,mrcWtrMrkRmk,mrcLegalFilingRmks,uinNo"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="mrcWaterMark" dso="uinNo,mrcLegalFilingRmks,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcLegalFilingDoc,IRDADate"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="uinNo,mrcLegalFilingRmks,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcLegalFilingDoc,IRDADate"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="uinNo,mrcLegalFilingRmks,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcLegalFilingDoc,IRDADate" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="IRDADate" type="DATETIME"></bizsolo:initDS>
<bizsolo:initDS name="mrcLegalFilingDoc" type="DOCUMENT"></bizsolo:initDS>
...
<bizsolo:initDS name="mrcLegalFilingRmks" type="STRING"></bizsolo:initDS>
<bizsolo:initDS name="uinNo" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="uinNo,mrcLegalFilingRmks,mrcWtrMrkRmk,ticketNo,subCategory,processTime,category,application,mrcLegalFilingDoc,IRDADate,mrcWaterMark"></bizsolo:executeAction>
</bizsolo:if>

<title>Creative Filing</title>
...
<input name="_PageName" type="hidden" value="Creative Filing">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Creative Filing.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<div class='header'>Creative Filing Activity</div>
    <br clear="all">
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataVal" id="table1_V1_V1" width="100%">
      <tbody>
        <tr>
...
%>
  ...
  Marcom Creative attached Docs : 

</span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document1"><bizsolo:getDS type="field" name="mrcWaterMark" multiline="true" wsName="Creative Filing" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table1_V1" width="100%">
  ...
  Enter Creative Filing Date : 
   ...
   Attach your Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="mrcLegalFilingDoc" multiline="true" wsName="Creative Filing" appendWith="false"></bizsolo:getDS></div>
...
<sfe:widget name="sbm.textfield" id="textField2" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="wtrMrkRmks" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
...
function validDateMsg(){
var abc ="Date should not be future date.";
Ext.MessageBox.alert("Select Date", abc, null);
}
...
$(document).ready(function(){
 ...
 function dateTime1_onChange(eventContext){
{
if(!checkValidDate(document.getElementById('dateTime1').value))
  {
    validDateMsg();
...
var allWidgets = [{widget:'dateTime1', bound:'true', editable:'true', type:'form.datetime', source: {type:'DATASLOT', dataSlotName:'IRDADate', dataSlotType:'DATETIME'}, target:{type:'DATASLOT', dataSlotName:'IRDADate', dataSlotType:'DATETIME'}, dsType:'DATETIME', service:'false'},
...
{widget:'legalRmks', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'mrcLegalFilingRmks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'mrcLegalFilingRmks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("CreativeFiling.jsp")%>';
