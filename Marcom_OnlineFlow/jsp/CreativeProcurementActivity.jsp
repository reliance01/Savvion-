...
<%! String _PageName = "Creative Procurement Activity"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="uwDocs,legalDocs,mrcWaterMark,application,category,processTime,subCategory,ticketNo,commTyp,mrcWtrMrkRmk,uinNo,legalRemarks,uwRemarks"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="uwDocs" dso="uwRemarks,legalRemarks,uinNo,mrcWtrMrkRmk,commTyp,ticketNo,subCategory,processTime,category,application,mrcWaterMark,legalDocs"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="uwRemarks,legalRemarks,uinNo,mrcWtrMrkRmk,commTyp,ticketNo,subCategory,processTime,category,application,mrcWaterMark,legalDocs"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="uwRemarks,legalRemarks,uinNo,mrcWtrMrkRmk,commTyp,ticketNo,subCategory,processTime,category,application,mrcWaterMark,legalDocs" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="uwRemarks" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="uwRemarks,legalRemarks,uinNo,mrcWtrMrkRmk,commTyp,ticketNo,subCategory,processTime,category,application,mrcWaterMark,legalDocs,uwDocs"></bizsolo:executeAction>
</bizsolo:if>

<title>Creative Procurement Activity</title>
...
<input name="_PageName" type="hidden" value="Creative Procurement Activity">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Creative Procurement Activity.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<div class='header'>Marcom Team Creative Activity</div>
    <br clear="all">
...
%>
  ...
  U/W attached Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document3"><bizsolo:getDS type="field" name="uwDocs" multiline="true" wsName="Creative Procurement Activity" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table4_V1" width="100%">
  ...
  String rmks = bean.getPropString("legalRemarks");
...
%>
  ...
  Legal Team attached Docs : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="legalDocs" multiline="true" wsName="Creative Procurement Activity" appendWith="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table6" width="100%">
  ...
  Upload Updated Creatives & More : 
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document1"><bizsolo:getDS type="field" name="mrcWaterMark" multiline="true" wsName="Creative Procurement Activity" appendWith="false"></bizsolo:getDS></div>
...
<sfe:widget name="sbm.textfield" id="textField2" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="comT" args="{'type':'text', 'size':20, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="wtrMrkRmks" args="{'type':'text', 'size':20, 'maxlength':2000, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
...
var allWidgets = [{widget:'textField2', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'application', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'application', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'comT', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'commTyp', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'commTyp', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'wtrMrkRmks', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'mrcWtrMrkRmk', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'mrcWtrMrkRmk', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
...
{widget:'textField4', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'legalRemarks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'legalRemarks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField5', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'uwRemarks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'uwRemarks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'}
];
var businessObjects = [];
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("CreativeProcurementActivity.jsp")%>';
