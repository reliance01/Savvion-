<%--  This JSP has been generated by using from xsl version 9.0 at Wed Mar 09 17:54:23 IST 2022 --%>
<!DOCTYPE html>
...
<%! String _PageName = "UnderWriterTeam"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="userUpload,onlineTeamUpload,uwDocs,application,category,onlineTeamRmks,priorty,subCategory,ticketNo,userRemarks,processTime,uwRemarks,uwApprovalStatus,uinNo"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="CREATOR,onlineTeamUpload,userUpload" dso="uinNo,uwApprovalStatus,uwRemarks,processTime,userRemarks,ticketNo,subCategory,priorty,onlineTeamRmks,category,application,uwDocs"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="uinNo,uwApprovalStatus,uwRemarks,processTime,userRemarks,ticketNo,subCategory,priorty,onlineTeamRmks,category,application,uwDocs"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="uinNo,uwApprovalStatus,uwRemarks,processTime,userRemarks,ticketNo,subCategory,priorty,onlineTeamRmks,category,application,uwDocs" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="uinNo" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="uinNo,uwApprovalStatus,uwRemarks,processTime,userRemarks,ticketNo,subCategory,priorty,onlineTeamRmks,category,application,CREATOR,uwDocs,onlineTeamUpload,userUpload"></bizsolo:executeAction>
</bizsolo:if>

<title>UnderWriterTeam</title>
...
<input name="_PageName" type="hidden" value="UnderWriterTeam">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.UnderWriterTeam.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<div class='header'>Under Writer Team Activity</div>
          </td>
        </tr>
      </tbody>
    </table>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2" width="100%">
  ...
  <%= com.rgicl.marcom.BasicUtility.getNameOfUser(bean.getPropString("CREATOR")) %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document1"><bizsolo:getDS type="field" name="userUpload" multiline="true" wsName="UnderWriterTeam" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table3" width="100%">
  ...
  <%= bean.getPropString("priorty") %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="onlineTeamUpload" multiline="true" wsName="UnderWriterTeam" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table4" width="100%">
      <tbody>
        <tr>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldNameBig'>Enter your Remark : </span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
<textarea id='rmks' rows='2' cols='30' ></textarea>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldNameBig'>Attach your Docs : </span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document3"><bizsolo:getDS type="field" name="uwDocs" multiline="true" wsName="UnderWriterTeam" appendWith="false"></bizsolo:getDS></div>
        ...
        <tr>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldName'>Select Status : </span>
          </td>
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
...
<sfe:widget name="sbm.textfield" id="textField1" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':true, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="textField8" args="{'type':'text', 'size':20, 'maxlength':2000, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="uwRmks" args="{'type':'text', 'size':20, 'maxlength':2000, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="status" args="{'type':'text', 'size':20, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("UnderWriterTeam.jsp")%>';
