<%--  This JSP has been generated by using from xsl version 9.0 at Wed Mar 09 17:54:28 IST 2022 --%>
<!DOCTYPE html>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="circulationDate,ticketNo,dateVal,application,category,subCategory,uinNo,processTime"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="" dso="circulationDate,ticketNo,dateVal,application,category,subCategory,uinNo,processTime"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="circulationDate,ticketNo,dateVal,application,category,subCategory,uinNo,processTime"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="circulationDate,ticketNo,dateVal,application,category,subCategory,uinNo,processTime" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="dateVal" type="DATETIME"></bizsolo:initDS>
...
<bizsolo:initDS name="processTime" type="LONG"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="circulationDate,ticketNo,dateVal,application,category,subCategory,uinNo,processTime"></bizsolo:executeAction>
</bizsolo:if>
...
<input name="_PageName" type="hidden" value="Circulation">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Circulation.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
{widget:'dateTime2', bound:'true', editable:'true', type:'form.datetime', source: {type:'DATASLOT', dataSlotName:'dateVal', dataSlotType:'DATETIME'}, target:{type:'DATASLOT', dataSlotName:'dateVal', dataSlotType:'DATETIME'}, dsType:'DATETIME', service:'false'},
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("Circulation.jsp")%>';
