<%--  This JSP has been generated by using from xsl version 9.0 at Wed Mar 09 17:54:22 IST 2022 --%>
<!DOCTYPE html>
...
<%! String _PageName = "UnderWriter Approval"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="userUpload,marcomTeamUpload,uwDocs,application,category,priorty,subCategory,ticketNo,userRemarks,processTime,uwRemarks,uwApprovalStatus,marcomRmks,uinNo"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="userUpload,marcomTeamUpload,CREATOR" dso="uwDocs,application,category,priorty,subCategory,ticketNo,userRemarks,processTime,uwRemarks,uwApprovalStatus,marcomRmks,uinNo"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="uwDocs,application,category,priorty,subCategory,ticketNo,userRemarks,processTime,uwRemarks,uwApprovalStatus,marcomRmks,uinNo"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="uwDocs,application,category,priorty,subCategory,ticketNo,userRemarks,processTime,uwRemarks,uwApprovalStatus,marcomRmks,uinNo" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:initDS name="uinNo" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="userUpload,marcomTeamUpload,uwDocs,CREATOR,application,category,priorty,subCategory,ticketNo,userRemarks,processTime,uwRemarks,uwApprovalStatus,marcomRmks,uinNo"></bizsolo:executeAction>
</bizsolo:if>

<title>UnderWriter Approval</title>
...
<input name="_PageName" type="hidden" value="UnderWriter Approval">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.UnderWriter Approval.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2_V1" width="100%">
  ...
  <%= com.rgicl.marcom.BasicUtility.getNameOfUser(bean.getPropString("CREATOR")) %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document1_V1"><bizsolo:getDS type="field" name="userUpload" multiline="true" wsName="UnderWriter Approval" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2_V1_V1" width="100%">
  ...
  <%= bean.getPropString("priorty") %>
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValue'>
            <div style="display: inline;" id="document2"><bizsolo:getDS type="field" name="marcomTeamUpload" multiline="true" wsName="UnderWriter Approval" appendWith="false" writePerm="false"></bizsolo:getDS></div>
...
<table align="left" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table4" width="100%">
  ...
  <textarea id='rmks' rows='2' cols='30' ></textarea>  
  ...
  Attach your Docs :
          ...
          <td class="ApSegDataVal" id="" rowspan="1" colspan="1">
            <span class='fieldValueBig'>
            <div style="display: inline;" id="document3"><bizsolo:getDS type="field" name="uwDocs" multiline="true" wsName="UnderWriter Approval" appendWith="false"></bizsolo:getDS></div>
...
<sfe:widget name="sbm.textfield" id="textField1" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':true, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
    ...
    <sfe:widget name="sbm.textfield" id="uwRmks" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />

    <sfe:widget name="sbm.textfield" id="status" args="{'type':'text', 'size':30, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'', 'tabOrder':'0'}" />
...
{widget:'textField7', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ticketNo', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'ticketNo', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField8', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'userRemarks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'userRemarks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'textField9', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'processTime', dataSlotType:'LONG'}, target:{type:'DATASLOT', dataSlotName:'processTime', dataSlotType:'LONG'}, dsType:'LONG', service:'false'},
{widget:'uwRmks', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'uwRemarks', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'uwRemarks', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'status', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'uwApprovalStatus', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'uwApprovalStatus', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
    ...
    sbm.utils.onFormSubmit = function() {
        ...
        try{
            ...
            return false;
                            ...
                            document.form.action='<%=response.encodeURL("UnderWriterApproval.jsp")%>';
